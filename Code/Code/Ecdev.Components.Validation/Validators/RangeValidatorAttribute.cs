...
namespace Ecdev.Components.Validation.Validators
{
	...
	public sealed class RangeValidatorAttribute : ValueValidatorAttribute
	{
        ...
        public RangeValidatorAttribute(int lowerBound, RangeBoundaryType lowerBoundType, int upperBound, RangeBoundaryType upperBoundType)
            : this((IComparable)lowerBound, lowerBoundType, upperBound, upperBoundType)//修改1;
		{
		}
        public RangeValidatorAttribute(double lowerBound, RangeBoundaryType lowerBoundType, double upperBound, RangeBoundaryType upperBoundType)
            : this((IComparable)lowerBound, lowerBoundType, upperBound, upperBoundType)//修改1;
		{
		}
        public RangeValidatorAttribute(DateTime lowerBound, RangeBoundaryType lowerBoundType, DateTime upperBound, RangeBoundaryType upperBoundType)
            : this((IComparable)lowerBound, lowerBoundType, upperBound, upperBoundType)//修改1;
		{
		}
        public RangeValidatorAttribute(long lowerBound, RangeBoundaryType lowerBoundType, long upperBound, RangeBoundaryType upperBoundType)
            : this((IComparable)lowerBound, lowerBoundType, upperBound, upperBoundType)//修改1;
		{
		}
        public RangeValidatorAttribute(string lowerBound, RangeBoundaryType lowerBoundType, string upperBound, RangeBoundaryType upperBoundType)
            : this((IComparable)lowerBound, lowerBoundType, upperBound, upperBoundType)//修改1;
		{
		}
        public RangeValidatorAttribute(float lowerBound, RangeBoundaryType lowerBoundType, float upperBound, RangeBoundaryType upperBoundType)
            : this((IComparable)lowerBound, lowerBoundType, upperBound, upperBoundType)//修改1;
		{
		}
