...
{
    public class Common_ActivityTime : AscxTemplatedWebControl
    {
        public const string TagID = "list_ActivityTime";
        ...
        public Common_ActivityTime()
        {
            base.ID = "list_ActivityTime";
        }
        protected override void OnInit(System.EventArgs e)
        {
            if (this.SkinName == null)
            {
                this.SkinName = "/ascx/tags/Common_UserCenter/Skin-Common_ActivityTime.ascx";
            }
            base.OnInit(e);
        }
