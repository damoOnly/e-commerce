...
namespace EcShop.Framework
{
	...
	{
		public const string CacheCopyrightKey = "Ecshop_SiteLicense";
		...
		public static bool CheckCopyright()
		{
			...
			XmlDocument xmlDocument = EcCache.Get(CacheCopyrightKey) as XmlDocument;
			...
			if (xmlDocument == null)
			{
                ...
                try
                {
                    ...
                    license = EcCryptographer.Decrypt(text);
                }
                catch
                {
                    return false;
                ...
                EcCache.Max(CacheCopyrightKey, xmlDocument, new CacheDependency(license));
			}
			...
			else
			{
                ...
                if (result)
                {
                    ...
                    OpenWeixin = openWeixinNode.InnerText.Equals("1");
        ...
        /// 
        /// </summary>
        /// <param name="serviceType">服务类型：service\pc\weixing\app\wap\alioh</param>
        /// <returns></returns>
        ...
        private static bool OpenWeixin
        {
            get;
            set;
        }
