...
namespace Ecdev.Transfers.TaobaoExporters
{
    public class Yfx1_2_to_Taobao5_0 : ExportAdapter
    {
        ...
        public Yfx1_2_to_Taobao5_0(params object[] exportParams) : this()
        {
            ...
            {
                this._zipFilename = string.Format("淘宝数据包_{0}-{1}.zip", (string)(exportParams[6]), (string)(exportParams[7]));
            }

            else
            {
                this._zipFilename = "淘宝数据包.zip";
            }
        }
