...
namespace Ecdev.Plugins.OpenId.AliPay
{
    ...
    public class AliPayService : OpenIdService
    {
        ...
        public override string Logo
        {
            get
            {
                return "Ecdev.Plugins.OpenId.AliPay.alipayservice.gif";
            }
        }
