...
namespace Ecdev.Plugins.OpenId.Sina
{
    public class Cookie
    {
        ...
        private Ecdev.Plugins.OpenId.Sina.TimeUnit _unit;

        public Cookie(string cookieName, int expires, Ecdev.Plugins.OpenId.Sina.TimeUnit unit)
        {
        ...
        private DateTime CacluteExpiresTime()
        {
            ...
            {
                case Ecdev.Plugins.OpenId.Sina.TimeUnit.Minute:
                    return now.AddMinutes((double) this.Expires);

                case Ecdev.Plugins.OpenId.Sina.TimeUnit.Hour:
                    return now.AddHours((double) this.Expires);

                case Ecdev.Plugins.OpenId.Sina.TimeUnit.Day:
                    return now.AddDays((double) this.Expires);

                case Ecdev.Plugins.OpenId.Sina.TimeUnit.Month:
                    return now.AddMonths(this.Expires);

                case Ecdev.Plugins.OpenId.Sina.TimeUnit.Year:
        ...
        public Ecdev.Plugins.OpenId.Sina.TimeUnit TimeUnit
        {
            get
            {
                return this._unit;
