...
namespace Ecdev.Plugins.OpenId.Sina
{
    ...
    public class SinaService : OpenIdService
    {
        ...
        public override string Logo
        {
            get
            {
                return "ecdev.plugins.openid.sina.sinaservice.gif";
            }
        }
