    ...
    public class HmacMD5
    {
        ...
        private void decode(ref uint[] output, byte[] input, uint len)
        {
            ...
            if (BitConverter.IsLittleEndian)
            {
                ...
                {
                    output[num] = (uint) (((input[num2] | (input[(int) ((IntPtr) ((ulong) (num2 + 1)))] << 8)) | (input[(int) ((IntPtr) ((ulong) (num2 + 2)))] << 0x10)) | (input[(int) ((IntPtr) ((ulong) (num2 + 3)))] << 0x18));
                    num++;
                }
            }
            else
            {
                ...
                for (num2 = 0; num2 < len; num2 += 4)
                {
                    output[num] = (uint) (((input[(int) ((IntPtr) (num2 + 3))] | (input[(int) ((IntPtr) ((ulong) (num2 + 2)))] << 8)) | (input[(int) ((IntPtr) ((ulong) (num2 + 1)))] << 0x10)) | (input[num2] << 0x18));
                    num++;
                }
            }
        }
        ...
        public byte[] finalize()
        {
            ...
            this.encode(ref output, this.count, 8);
        ...
        private void transform(byte[] data)
        {
            ...
            this.decode(ref output, data, 0x40);
