namespace Ecdev.Plugins.Payment.Alipay
{
    using Ecdev.Plugins;
    using System;
    ...
    [Plugin("支付宝标准双接口", Sequence=3)]
    public class StandardRequest : PaymentRequest
    {
        ...
        private const string Service = "trade_create_by_buyer";
        ...
        public StandardRequest(string orderId, decimal amount, string subject, string body, string buyerEmail, DateTime date, string showUrl, string returnUrl, string notifyUrl, string attach)
        {
        ...
        {
            this.RedirectToGateway(Globals.CreatUrl("https://mapi.alipay.com/gateway.do?", "trade_create_by_buyer", this.Partner, "MD5", this.outTradeNo, this.subject, this.body, "1", this.price, this.showUrl, this.SellerEmail, this.Key, this.returnUrl, "utf-8", this.notifyUrl, "EXPRESS", "0.00", "BUYER_PAY", "1", "C4335302345904805116", "isv^yf31", this.token));
        }
