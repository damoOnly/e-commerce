namespace Ecdev.Plugins.Payment.GoPay
{
    using Ecdev.Plugins;
    using System;
    ...
    public class GoPayRequest : PaymentRequest
    {
        ...
        private const string GatewayUrl = "https://www.gopay.com.cn/PGServer/Trans/WebClientAction.do";
        ...
        public override void SendRequest()
        {
            ...
            this.SubmitPaymentForm(this.CreateForm(builder.ToString(), "https://www.gopay.com.cn/PGServer/Trans/WebClientAction.do"));
        }
