...
{
    public class HSTradeTypeDropDownList : DropDownList
    {
        private bool allowNull = true;
        private string nullToDisplay = "--请选择成交方式--";
        ...
        public override void DataBind()
        {
            ...
            DataTable dtCountry = PurchaseOrderHelper.GetBaseEnumDictList("TradeType");
