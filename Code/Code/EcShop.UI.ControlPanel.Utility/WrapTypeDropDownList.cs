...
{
    public class WrapTypeDropDownList : DropDownList
    {
        private bool allowNull = true;
        private string nullToDisplay = "--请选择包装种类--";
        ...
        public override void DataBind()
        {
            ...
            DataTable dtCountry = PurchaseOrderHelper.GetBaseEnumDictList("WrapType");
