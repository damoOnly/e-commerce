...
namespace EcShop.UI.ControlPanel.Utility
{
	public class RoleDropDownList : DropDownList
	{
		...
		{
			return string.Compare(roleName, HiContext.Current.Config.RolesConfiguration.Manager, true, CultureInfo.InvariantCulture) == 0 || string.Compare(roleName, HiContext.Current.Config.RolesConfiguration.Member, true, CultureInfo.InvariantCulture) == 0;
		}
	}
}
