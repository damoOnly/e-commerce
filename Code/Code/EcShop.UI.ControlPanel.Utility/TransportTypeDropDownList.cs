...
{
    public class TransportTypeDropDownList : DropDownList
    {
        private bool allowNull = true;
        private string nullToDisplay = "--请选择运输方式--";
        ...
        public override void DataBind()
        {
            ...
            DataTable dtCountry = PurchaseOrderHelper.GetBaseEnumDictList("TransportType");
