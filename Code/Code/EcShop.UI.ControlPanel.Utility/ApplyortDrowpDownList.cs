...
{
    public class ApplyortDrowpDownList : DropDownList
    {
        private bool allowNull = true;
        private string nullToDisplay = "--请选择进口口岸--";
        ...
        public override void DataBind()
        {
            ...
            DataTable dtCountry = PurchaseOrderHelper.GetBaseEnumDictList("applyortCode");
