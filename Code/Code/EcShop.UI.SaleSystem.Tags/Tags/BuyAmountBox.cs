...
{
	[ParseChildren(false), ToolboxData("<{0}:BuyAmountBox runat=\"server\"></{0}:BuyAmountBox>")]
	public class BuyAmountBox : WebControl
	{
		...
		protected override void CreateChildControls()
		{
			...
			webControl.Attributes.Add("value", this.Quantity.ToString(CultureInfo.InvariantCulture));
			...
			webControl2.Attributes.Add("value", this.Quantity.ToString(CultureInfo.InvariantCulture));
