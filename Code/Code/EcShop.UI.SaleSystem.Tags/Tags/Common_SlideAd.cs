	...
	public class Common_SlideAd : WebControl
	{
		...
		public string RendHtml()
		{
			...
			if (xmlNode != null)
			{
				...
				{
					stringBuilder.AppendFormat("<li><a href=\"{0}\" target=\"_blank\"><img src=\"{1}\" width=\"{2}\" height=\"{3}\" /></a></li>", new object[]
					{
						(xmlNode.Attributes["Url1"].Value.Length == 0) ? "" : xmlNode.Attributes["Url1"].Value,
				...
				if (!string.IsNullOrEmpty(xmlNode.Attributes["Image2"].Value))
				{
					stringBuilder.AppendFormat("<li><a href=\"{0}\" target=\"_blank\"><img src=\"{1}\" width=\"{2}\" height=\"{3}\" /></a></li>", new object[]
					{
						(xmlNode.Attributes["Url2"].Value.Length == 0) ? "" : xmlNode.Attributes["Url2"].Value,
				...
				if (!string.IsNullOrEmpty(xmlNode.Attributes["Image3"].Value))
				{
					stringBuilder.AppendFormat("<li><a href=\"{0}\" target=\"_blank\"><img src=\"{1}\" width=\"{2}\" height=\"{3}\" /></a></li>", new object[]
					{
						(xmlNode.Attributes["Url3"].Value.Length == 0) ? "" : xmlNode.Attributes["Url3"].Value,
				...
				if (!string.IsNullOrEmpty(xmlNode.Attributes["Image4"].Value))
				{
					stringBuilder.AppendFormat("<li><a href=\"{0}\" target=\"_blank\"><img src=\"{1}\" width=\"{2}\" height=\"{3}\" /></a></li>", new object[]
					{
						(xmlNode.Attributes["Url4"].Value.Length == 0) ? "" : xmlNode.Attributes["Url4"].Value,
				...
				if (!string.IsNullOrEmpty(xmlNode.Attributes["Image5"].Value))
				{
					stringBuilder.AppendFormat("<li><a href=\"{0}\" target=\"_blank\"><img src=\"{1}\" width=\"{2}\" height=\"{3}\" /></a></li>", new object[]
					{
						(xmlNode.Attributes["Url5"].Value.Length == 0) ? "" : xmlNode.Attributes["Url5"].Value,
				...
				if (!string.IsNullOrEmpty(xmlNode.Attributes["Image6"].Value))
				{
					stringBuilder.AppendFormat("<li><a href=\"{0}\" target=\"_blank\"><img src=\"{1}\" width=\"{2}\" height=\"{3}\" /></a></li>", new object[]
					{
						(xmlNode.Attributes["Url6"].Value.Length == 0) ? "" : xmlNode.Attributes["Url6"].Value,
				...
				if (!string.IsNullOrEmpty(xmlNode.Attributes["Image7"].Value))
				{
					stringBuilder.AppendFormat("<li><a href=\"{0}\" target=\"_blank\"><img src=\"{1}\" width=\"{2}\" height=\"{3}\" /></a></li>", new object[]
					{
						(xmlNode.Attributes["Url7"].Value.Length == 0) ? "" : xmlNode.Attributes["Url7"].Value,
				...
				if (!string.IsNullOrEmpty(xmlNode.Attributes["Image8"].Value))
				{
					stringBuilder.AppendFormat("<li><a href=\"{0}\" target=\"_blank\"><img src=\"{1}\" width=\"{2}\" height=\"{3}\" /></a></li>", new object[]
					{
						(xmlNode.Attributes["Url8"].Value.Length == 0) ? "" : xmlNode.Attributes["Url8"].Value,
				...
				if (!string.IsNullOrEmpty(xmlNode.Attributes["Image9"].Value))
				{
					stringBuilder.AppendFormat("<li><a href=\"{0}\" target=\"_blank\"><img src=\"{1}\" width=\"{2}\" height=\"{3}\" /></a></li>", new object[]
					{
						(xmlNode.Attributes["Url9"].Value.Length == 0) ? "" : xmlNode.Attributes["Url9"].Value,
				...
				if (!string.IsNullOrEmpty(xmlNode.Attributes["Image10"].Value))
				{
					stringBuilder.AppendFormat("<li><a href=\"{0}\" target=\"_blank\"><img src=\"{1}\" width=\"{2}\" height=\"{3}\" /></a></li>", new object[]
					{
						(xmlNode.Attributes["Url10"].Value.Length == 0) ? "" : xmlNode.Attributes["Url10"].Value,
