<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.ManageMenu" CodeBehind="~/Admin/vshop/ManageMenu.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="dataarea mainwidth databody">
  ...
  <span>自定义菜单能够帮助公众号丰富界面，让用户更好更快地理解公众号的功能。</span></div>  
	<div class="btn">	
   <span style="margin-right:13px;">目前自定义菜单最多包括3个一级菜单，每个一级菜单最多包含5个二级菜单。一级菜单最多5个汉字，二级菜单最多7个汉字，多出来的部分将会以“...”代替。请注意，创建自定义菜单后，由于微信客户端缓存，需要24小时微信客户端才会展现出来。建议测试时可以尝试取消关注公众账号后再次关注，则可以看到创建后的效果。</span></btn>
   </div>
