<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/Admin/vshop/AddActivity.aspx.cs"
    Inherits="EcShop.UI.Web.Admin.AddActivity" MasterPageFile="~/Admin/Admin.Master" %>
            ...
            <div class="formitem validator2">
                <ul>
                    ...
                    <li><span class="formitemtitle Pw_100"><em>*</em>活动表单项：</span> 
                        <asp:TextBox ID="txtItem1" runat="server" CssClass="forminput"></asp:TextBox><p id="ctl00_contentHolder_txtItem1Tip">至少填写一项</p>
                    </li>
