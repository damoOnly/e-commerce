<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"  Inherits="EcShop.UI.Web.Admin.vshop.SupplierAddNewProduct" %>
...
<div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1 id="h1title">添加新上商品</h1>
            <span id="spanTitle" class="font">添加新上商品</span>
      </div>
          <div class="formitem validator2">
            <ul>
              <li><span class="formitemtitle Pw_100">新上商品描述：</span>
         ...
         <!--隐藏图片地址-->
              ...
              <br />
                ...
                <li>小图：商品升序排序第二个起的商品 为大图，规格是213*任意高度,各小图的高度要一致，否则会显示错乱</li>
                <li>图文说明：
                    <img src="../images/newP.jpg" />
                </li>
           </ul> 
          </div>
  </div>    
