<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.vshop.ManageNewProduct" %>
...
<div class="dataarea mainwidth databody">
  ...
  <span>如果您选择了首页带有新上商品的模板，您需要在此配置好相关参数。</span></div>  
		<!-- 添加按钮-->
   <div class="btn">  <a class="submit_jia" href="javascript:DialogFrame('vshop/AddNewProduct.aspx?id=0','添加一个新上商品',null,600)">添加一个新上商品 </a></div>
          ...
          Width="100%" onrowcommand="grdRecommend_RowCommand">
                    ...
                    <UI:SortImageColumn HeaderText="排序" ItemStyle-Width="60px" ReadOnly="true" HeaderStyle-CssClass="td_right td_left"/>
                     <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                         <ItemTemplate>
                               <span class="submit_bianji"> <a  href="javascript:DialogFrame('<%# "vshop/AddNewProduct.aspx?Id="+ ((RecommendInfo)Container.DataItem).Id %>','编辑新上商品',null,null)">编辑</a> </span>
