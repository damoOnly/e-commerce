<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddLotteryTicket.aspx.cs" Inherits="EcShop.UI.Web.Admin.AddLotteryTicket" %>
...
//    initValid(new NumberRangeValidator('txtPrize2Num', 1, 999, '不允许为空，且必须为整数'));
//    initValid(new NumberRangeValidator('txtPrize3Num', 1, 999, '不允许为空，且必须为整数'));
}
