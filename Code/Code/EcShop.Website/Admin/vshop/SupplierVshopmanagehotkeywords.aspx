<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierVshopmanagehotkeywords.aspx.cs" Inherits="EcShop.UI.Web.Admin.vshop.SupplierVshopmanagehotkeywords" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
  ...
  <div id="AddHotKeyword" style="display:none;">
    <div class="frame-content">
     <p><span class="frame-span frame-input90"><em >*</em>&nbsp;商品分类：</span>
          <%--<Hi:ProductCategoriesDropDownList IsTopCategory="true" ID="dropCategory" runat="server" />--%>
         <Hi:ProductCategoriesDropDownList ID="dropCategory"  NullToDisplay="--请选择商品分类--" runat="server" />
     </p>
...
<div id="EditHotKeyword"  style=" display:none;">
  <div class="frame-content">
    <p><span class="frame-span frame-input90"><em >*</em>&nbsp;商品分类：</span>
        <%--<Hi:ProductCategoriesDropDownList IsTopCategory="true" ID="dropEditCategory" runat="server" />--%>
        <Hi:ProductCategoriesDropDownList ID="dropEditCategory"  NullToDisplay="--请选择商品分类--" runat="server" />

    </p>
    <p> <span class="frame-span frame-input90"><em >*</em>&nbsp;关键字名称：</span> <asp:TextBox ID="txtEditHotKeyword" runat="server" CssClass="forminput"></asp:TextBox>  
    </p>
