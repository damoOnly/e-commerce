<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.VServerConfig" CodeBehind="VServerConfig.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
        ...
        <div class="datafrom">
            <div class="formitem validator1">
                <ul>
                    ...
                    <li><span class="formitemtitle Pw_198">Token：</span>
                    ...
                    <li class="clearfix"><span class="formitemtitle Pw_198">微信官方登录接口：</span>
                    ...
                    <li class="clearfix"><span class="formitemtitle Pw_198">是否开通多客服：</span>
                        <input type="checkbox" id="chk_manyService" runat="server" /><label for="ctl00_contentHolder_chk_manyService">已开通</label><span style="color: Red;">(仅认证服务号可在公众平台开通多客服）</span>
                    </li>
                </ul>
