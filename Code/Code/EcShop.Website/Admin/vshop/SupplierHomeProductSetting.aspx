<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="SupplierHomeProductSetting.aspx.cs" Inherits="EcShop.UI.Web.Admin.vshop.SupplierHomeProductSetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript">
        function ShowAddDiv() {
            DialogFrame("./vshop/SupplierSearchHomeProduct.aspx", "添加首页商品", 975, null);
        }
    </script>
</asp:Content>
