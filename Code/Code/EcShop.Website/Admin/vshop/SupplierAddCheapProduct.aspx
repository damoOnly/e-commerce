<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.vshop.SupplierAddCheapProduct" %>
...
<div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1 id="h1title">添加特惠商品</h1>
            <span id="spanTitle" class="font">添加特惠商品</span>
      </div>
          <div class="formitem validator2">
            <ul>
              <li><span class="formitemtitle Pw_100">特惠商品描述：</span>
         ...
         <!--隐藏图片地址-->
              ...
              <br />
                <ul>
                <li>图片规则说明：</li>
                <li>图1：商品升序排序第一个商品 为图1，规格是640*任意高度</li>
                <li>图2：商品升序排序第二个商品 为图2，规格是320*289,，否则会显示错乱</li>
                <li>图3：商品升序排序第三个商品 为图3，规格是320*144,，否则会显示错乱</li>
                <li>图4：商品升序排序第四、五个商品 为图4，规格是160*144,，否则会显示错乱</li>
                <li>若要显示多排，则图2 应为商品升序排序第六个商品、图3应为第六个商品，依次类推</li>
                <li>图文说明：
                    <img src="../images/cheapP.png" />
                </li>
          </div>
  </div>    
  </div>
