<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ShengPaySet.aspx.cs" Inherits="EcShop.UI.Web.Admin.vshop.ShengPaySet" %>
        ...
        <div class="formitem validator1">
          <ul>
           ...
           <li class="clearfix"><span class="formitemtitle Pw_198">是否开启：</span>
            ...
            <Hi:YesNoRadioButtonList ID="radEnableVshopShengPay" runat="server" RepeatLayout="Flow" />
          </abbr>
            </li>
