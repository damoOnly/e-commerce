<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="UpdateLotteryActivity.aspx.cs" Inherits="EcShop.UI.Web.Admin.vshop.UpdateLotteryActivity" %>
    ...
    <div class="areacolumn clearfix">
        <div class="columnright">
            <div class="title">
                ...
                <span>
                    <asp:Literal ID="Litdesc" runat="server">大转盘编辑</asp:Literal></span>
            </div>
            <div class="formitem validator2">
                <ul>
                    ...
                    <li><span class="formitemtitle Pw_100">一等奖描述：<em>*</em></span>
                        ...
                        <span>&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability1" CssClass="forminput" runat="server"></asp:TextBox>
                        %<p id="txtPrize1Tip">
                            一等奖描述不能为空
                        </p>
                    </li>
                    <li><span class="formitemtitle Pw_100">二等奖描述：<em>*</em></span>
                        ...
                        <span>&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability2" CssClass="forminput" runat="server"></asp:TextBox>
                        %<p id="txtPrize2Tip">
                            二等奖描述不能为空
                        </p>
                    </li>
                    <li><span class="formitemtitle Pw_100">三等奖描述：<em>*</em></span>
                        ...
                        <span>&nbsp;奖品数量：&nbsp;</span><asp:TextBox ID="txtPrize3Num" CssClass="forminput" runat="server"></asp:TextBox>
                        <span>&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability3" CssClass="forminput" runat="server"></asp:TextBox>
                        %
                        <p id="txtPrize3Tip">
                            二等奖描述不能为空
                        </p>
                    ...
                    <li class="hiddenli"><span class="formitemtitle Pw_100">四等奖描述：</span>
                        ...
                        <span>&nbsp;奖品数量：&nbsp;</span><asp:TextBox ID="txtPrize4Num" CssClass="forminput" runat="server"></asp:TextBox>
                        <span>&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability4" CssClass="forminput" runat="server"></asp:TextBox>%
                    </li>
                    <li class="hiddenli"><span class="formitemtitle Pw_100">五等奖描述：</span>
                        ...
                        <span>&nbsp;奖品数量：&nbsp;</span><asp:TextBox ID="txtPrize5Num" CssClass="forminput" runat="server"></asp:TextBox>
                        <span>&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability5" CssClass="forminput" runat="server"></asp:TextBox>%
                    </li>
                    <li class="hiddenli"><span class="formitemtitle Pw_100">六等奖描述：</span>
                        ...
                        <span>&nbsp;奖品数量：&nbsp;</span><asp:TextBox ID="txtPrize6Num" CssClass="forminput" runat="server"></asp:TextBox>
                        <span>&nbsp;中奖概率：&nbsp;</span><asp:TextBox ID="txtProbability6" CssClass="forminput" runat="server"></asp:TextBox>%
                    </li>
