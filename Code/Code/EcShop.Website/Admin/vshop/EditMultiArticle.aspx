<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="EditMultiArticle.aspx.cs" Inherits="EcShop.UI.Web.Admin.vshop.EditMultiArticle" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server" ClientIDMode="Static">
            ...
            <div class="tw_body">
                ...
                <div id="box_move" class="tw_box box_left box_body">
                    <div class="cont_body">
                        ...
                        <div>
                            <span><em>*</em>封 面：</span> <span id="swfu_container"><span><span id="spanButtonPlaceholder">
                            </span></span><span id="divFileProgressContainer"></span></span>
                            <div>
                                建议尺寸：360*200</div>
            ...
            <div class="formitem validator2">
                <ul>
                    ...
                    <li class="likey"><span class="formitemtitle Pw_100"><em>*</em>关键字：</span>
                        ...
                        <p id="ctl00_contentHolder_txtKeysTip">
                            用户可通过该关键字搜到到这个内容</p>
                    </li>
                    <li class="likey"><span class="formitemtitle Pw_100">匹配模式：</span>
                        <Hi:YesNoRadioButtonList ID="radMatch" runat="server" RepeatLayout="Flow" YesText="模糊匹配"
                            NoText="精确匹配" />
                    </li>
                    <li><span class="formitemtitle Pw_100">状态：</span>
                        <Hi:YesNoRadioButtonList ID="radDisable" runat="server" RepeatLayout="Flow" YesText="启用"
                            NoText="禁用" />
                    </li>
                </ul>
            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){loadJsonData();});
        ...
        function EditMultArticles() {
            ...
            $.ajax({
                url: "./EditMultiArticle.aspx?cmd=Update&id="+MaterialID,
                type: "POST",
                dataType: "text",
