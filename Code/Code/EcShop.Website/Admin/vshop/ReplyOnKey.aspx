<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.ReplyOnKey"
        ...
        <div class="datalist">
            <UI:Grid ID="grdArticleCategories" runat="server" ShowHeader="true" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="回复类型" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="最后修改日期" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <asp:Literal runat="server" Text='<%# Eval("LastEditDate") %>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="最后修改人" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
