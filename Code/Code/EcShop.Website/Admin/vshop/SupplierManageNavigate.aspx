<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierManageNavigate.aspx.cs" Inherits="EcShop.UI.Web.Admin.vshop.SupplierManageNavigate" %>
...
<div class="dataarea mainwidth databody">
  ...
  <span>如果您选择了首页带有图标的模板，您需要在此配置好相关参数。</span></div>  
		<!-- 添加按钮-->
   <div class="btn">  <a class="submit_jia" href="javascript:DialogFrame('Vshop/SupplierAddNavigate.aspx','添加一个图标',null,600)">添加一个图标 </a></div>
          ...
          Width="100%" onrowcommand="grdNavigate_RowCommand">
                    ...
                    <asp:TemplateField HeaderText="描述"  HeaderStyle-CssClass="td_right td_left">
                      ...
                      <asp:TemplateField HeaderText="跳转至"  HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <span class="Name" style="max-width:465px;overflow: hidden;"><%#((NavigateInfo)Container.DataItem).LocationType.ToShowText()%> 
<%#((NavigateInfo)Container.DataItem).LocationType == LocationType.Phone ? ((NavigateInfo)Container.DataItem).Url : ((NavigateInfo)Container.DataItem).LoctionUrl%>
                    ...
                    <UI:SortImageColumn HeaderText="排序" ItemStyle-Width="60px" ReadOnly="true" HeaderStyle-CssClass="td_right td_left"/>
                     <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                         <ItemTemplate>
                               <span class="submit_bianji"> <a  href="javascript:DialogFrame('<%# "Vshop/SupplierEditNavigate.aspx?Id="+ ((NavigateInfo)Container.DataItem).Id %>','编辑图标',null,null)">编辑</a> </span>
