<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.SendMessageTemplets" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="dataarea mainwidth databody">
	  <div class="title"> <em><img src="../images/01.gif" width="32" height="32" /></em>
	    <h1>消息提醒设置</h1>
	    <span>在这里可以管理短信、邮件、站内信和微信的发送，以及短信、邮件和站内信的配置和相关的模版设置。</span>
     </div>
	  <!-- 添加按钮-->
	  <!--结束-->
	  <!--数据列表区域-->
<div class="datalist">
	    <div class="search clearfix searcha">
			<ul>
                ...
                <li class="Pg_45"><img src="../images/wechat.jpg" width="12" height="13" /></li>
                <li>微信</li>
                <li><a href="WeixinSettings.html" target="_blank">配置</a></li>
                 <li class="Pg_45"><img src="../images/xinge.jpg" width="12" height="13" /></li>
                <li>信鸽</li>
                <li><a href="XinGeSettings.aspx">配置</a></li>
			</ul>
	</div>
	  <UI:Grid ID="grdEmailTemplets" runat="server" ShowHeader="true" DataKeyNames="MessageType" AutoGenerateColumns="false" GridLines="None" Width="100%">
	    <HeaderStyle CssClass="table_title" />
            <Columns>
                ...
                <asp:TemplateField HeaderText="信鸽" HeaderStyle-CssClass="td_left td_right_fff">                                                                                                       
                    <ItemTemplate>  
                    <table cellpadding="0" cellspacing="0" style="border:none;">
                    <tr><td style="border:none; width:10px;"><asp:CheckBox runat="server" MessageType='<%# Eval("Name")%>' ID="chkXinGeSend"  Checked='<%# Eval("XinGeSend")%>' /></td>
                    <td style="border:none;"><span class="submit_bianji"  MessageType='<%# Eval("Name")%>'><a href='<%# "EditXinGeMessageTemplet.aspx?MessageType="+Eval("MessageType")%>'>编辑</a></span></td></tr>
                    </table>                          
                    </ItemTemplate>
                </asp:TemplateField>                           
            </Columns>
