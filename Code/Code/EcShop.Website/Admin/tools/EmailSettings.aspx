<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.EmailSettings" MasterPageFile="~/Admin/Admin.Master" %>
...
<p>如果您需要经常面向大量用户邮箱进行邮件群发，建议你开通更高品质的<font style="color:Red">EDM邮件营销服务。</font><a href="http://fw.ecdev.cn/edm/
" target="_blank" >点此开通</a></p>
          ...
          <li style="margin-bottom:0px;"><span class="formitemtitle Pw_140">发送方式：</span>
             <span class="formselect"> <select id="ddlEmails" name="ddlEmails"></select></span>
            </li>
...
<ul style="margin:5px 0px; height:30px;">
          ...
          <ul class="btntf Pa_140 clear" style="margin:10px 0px; height:30px;">
             <asp:Button ID="btnTestEmailSettings" runat="server" OnClientClick="return TestCheck();" Text="发送测试邮件"  CssClass="submit_DAqueding inbnt"> </asp:Button >	
      </ul>
</div>
      </div>
</div>
