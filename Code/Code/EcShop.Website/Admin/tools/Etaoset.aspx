<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Etaoset.aspx.cs" Inherits="EcShop.UI.Web.Admin.Etaoset"
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody">
        <div class="title m_none m_none td_bottom">
            ...
            <span>您可以申请独立商城免费入驻一淘（open.etao.com）,并通过这里的设置将独立商城的商品及分类信息生成Feed文件，提交到一淘（www.etao.com）收录商品和分类信息。</span>
        </div>
        <div class="datafrom">
            <div class="formitem">
                <ul>
                    ...
                    <li runat="server"  id="fulDir"><span>全量索引目录:</span><asp:Label runat="server" ID="lblEtaoFeedFull" />
                                   <p>供一淘（open.etao.com）搜索引擎自动抓取的全量商品FEED文件的存放目录，每天凌晨会抓取一次。</p>
                                   </li>
