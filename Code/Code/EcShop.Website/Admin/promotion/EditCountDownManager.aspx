<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditCountDownManager.aspx.cs" Inherits="EcShop.UI.Web.Admin.EditCountDownManager" %>
            ...
            <div class="formitem validator5" style="padding-left: 15px;">
                <ul>
                    ...
                    <li> <span class="formitemtitle Pw_140">活动图片连接地址：</span>
                        ...
                        <p id="ctl00_contentHolder_txtCompanyUrlTip">活动连接地址必须以http://开头，长度限制在100个字符以内'</p>
                    </li>
                </ul>
                <ul class="btn Pa_100 clear">
                    <li>
                         <div style="float:left"><asp:Button ID="btnUpdateCountDown" runat="server" Text="编辑"  CssClass="submit_DAqueding" /></div>&nbsp;
                ...
                <asp:HiddenField ID="hidd_ImgSrc" runat="server" />
            </div>
        </div>
    </div>
