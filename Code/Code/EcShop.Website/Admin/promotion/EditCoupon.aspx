<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditCoupon.aspx.cs" Inherits="EcShop.UI.Web.Admin.EditCoupon" %>
...
<div class="areacolumn clearfix">
      ...
      <ul class="btn Pa_100 clear">
         <asp:Button ID="btnEditCoupons" runat="server" Text="保 存" OnClientClick="return PageIsValid();"  CssClass="submit_DAqueding"  />
        </ul>
      </div>
