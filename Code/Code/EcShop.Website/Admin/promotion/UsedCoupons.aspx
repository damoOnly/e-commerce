<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="UsedCoupons.aspx.cs" Inherits="EcShop.UI.Web.Admin.UsedCoupons" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" Runat="Server">
  ...
  <div class="dataarea mainwidth databody">
    <div class="title"> <em><img src="../images/06.gif" width="32" height="32" /></em>
     ...
     <asp:HiddenField ID="nowCouponId" runat="server" />
        <div class="searcharea clearfix br_search">
			<ul class="a_none_left">           
                ...
                <li><span>用户名：</span><span><asp:TextBox ID="txtUserName" runat="server" CssClass="forminput" /></span></li>
                <li><span>发送人：</span><span><asp:TextBox ID="txtAddUserName" runat="server" CssClass="forminput" /></span></li>	
                 <li><span>发劵时间从：</span><UI:WebCalendar CalendarType="StartDate" ID="calendarStart" runat="server"  class="forminput" /></li>
            <li><span>至：</span><UI:WebCalendar ID="calendarEnd" runat="server" CalendarType="EndDate"   class="forminput"/></li>
                ...
                <li><asp:Button ID="btnExport" runat="server" Text="导出" onclick="btnExport_Click" /></li>
		  </ul>
	  </div>
   ...
   <UI:Grid ID="grdCoupons" runat="server" AutoGenerateColumns="False" Width="100%" DataKeyNames="CouponId" HeaderStyle-CssClass="table_title" GridLines="None"  SortOrderBy="CouponId" SortOrder="DESC">
                               ...
                               <asp:TemplateField HeaderText="优惠券名称"  HeaderStyle-CssClass="td_right td_left">
                                  <ItemTemplate>
                                     ...
                                     <asp:BoundField DataField="ClaimCode" HeaderText="优惠码" HtmlEncode="false" HeaderStyle-CssClass="td_right td_left"></asp:BoundField>    
                                      <asp:BoundField DataField="UserName" HeaderText="获劵用户名" HtmlEncode="false" HeaderStyle-CssClass="td_right td_left"></asp:BoundField>
                       ...
                       <asp:BoundField DataField="AddUserName" HeaderText="发送人" HtmlEncode="false" HeaderStyle-CssClass="td_right td_left"></asp:BoundField>
