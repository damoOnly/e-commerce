...
<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SearchPromotionPresentPro.aspx.cs" Inherits="EcShop.UI.Web.Admin.SearchPromotionPresentPro" %>
	  ...
	  <div class="datalist">
	  		<div class="searcharea clearfix">
			    <ul>
                    ...
                    <li class="formselect"><Hi:SupplierDropDownList runat="server" ID="dropSupplier" NullToDisplay="--请选择供应商--"/></li>
