<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditCountDown.aspx.cs" Inherits="EcShop.UI.Web.Admin.EditCountDown" %>
...
<script type="text/javascript" language="javascript">
      function InitValidators() {
          ...
          initValid(new InputValidator('ctl00_contentHolder_txtPlanCount', 1, 10, false, '-?[0-9]\\d*', '数据类型错误，限购数量只能输入整数型数值'))
      ...
      <div class="formitem validator5" style="padding-left:15px;">      
        ...
        <li><span class="formitemtitle Pw_140">限时抢购商品：</span>
          ...
          <li><span class="formitemtitle Pw_140"><em >*</em>限时抢购价格：</span>
           ...
           <p id="ctl00_contentHolder_txtMaxCountTip">限时抢购每个人能抢购的数量(0表示不限购)</p>
          </li>
