<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SetSEO.aspx.cs" Inherits="EcShop.UI.Web.Admin.SetSEO" %>
            ...
            <div class="formitem validator1">
                <ul>
                    <li><span class="formitemtitle Pw_198">简单介绍：</span>
                        ...
                        <p id="txtSiteDescriptionTip" runat="server">简单介绍，长度限制在100字符以内</p>
                    </li>
                    <li><span class="formitemtitle Pw_198">商城描述：</span>
                        <asp:TextBox ID="txtSearchMetaDescription" runat="server" CssClass="forminput formwidth"></asp:TextBox>
                        <p id="txtSearchMetaDescriptionTip" runat="server">商城描述,长度必须控制在260个字符以内</p>
                    </li>
                    <li><span class="formitemtitle Pw_198">搜索关键字：</span>
                        ...
                        <p id="txtSearchMetaKeywordsTip" runat="server">搜索关键字，长度必须控制在160个字符以内</p>
                    </li>
                </ul>
                <div class="clear"></div>
