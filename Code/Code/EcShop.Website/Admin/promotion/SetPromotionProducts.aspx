<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SetPromotionProducts.aspx.cs" Inherits="EcShop.UI.Web.Admin.SetPromotionProducts" Title="无标题页" %>
...
<div class="dataarea mainwidth databody">
    ...
    <div class="btn">
       ...
       <a class="submit_jia" href="javascript:void(0)" onclick="ShowAddDiv()">添加促销商品</a> <asp:LinkButton ID="btnCreateReport" runat="server" Text="导出活动商品" />
    </div>
	  <!--数据列表区域-->
  <div class="datalist">
