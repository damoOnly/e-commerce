<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CountDowns.aspx.cs" Inherits="EcShop.UI.Web.Admin.CountDowns" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
  ...
  <span>限时抢购活动</span>
	    ...
	    <div class="btn"  style="float:left;">
          <a href="AddCountDown.aspx" class="submit_jia">添加限时抢购活动</a>
	    </div>

         <div class="btn"  style="float:left;">
          <a href="CountDownsManager.aspx" class="submit_jia">限时购活动管理</a>
	    </div>
            </div>
		<!--数据列表区域-->
...
<div class="functionHandleArea clearfix m_none">
            ...
            <Columns>                 
                 ...
                 <asp:TemplateField HeaderText="商品名称" HeaderStyle-CssClass="td_right td_left"  ItemStyle-Width="30%">
                       <ItemTemplate>
                        <a href='<%#"../../CountDownProductsDetails.aspx?productId="+Eval("ProductId")%>' target="_blank">
                 ...
                 <asp:TemplateField HeaderText="抢购价格"  ItemStyle-Width="10%"  HeaderStyle-CssClass="td_right td_left" >
                       <ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="操作" ItemStyle-Width="15%" HeaderStyle-CssClass="td_left td_right_fff" >
                     <ItemTemplate>
                         <span class="submit_bianji"><a href='<%# "EditCountDown.aspx?CountDownId=" + Eval("CountDownId")%> '>编辑</a></span>
