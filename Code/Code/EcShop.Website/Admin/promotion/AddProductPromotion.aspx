<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddProductPromotion.aspx.cs" Inherits="EcShop.UI.Web.Admin.AddProductPromotion" Title="无标题页" %>
...
<div class="areacolumn clearfix validator4">
    ...
    <div class="formitem validator4">
        ...
        <asp:RadioButton ID="radNo" runat="server" Checked="true" Text="不递增" GroupName="ascend" /></span></td>
                    </tr></table>
