<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="SupplierAppProductSetting.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierAppProductSetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript">
        function ShowAddDiv() {
            DialogFrame("./App/SupplierSearchAppProduct.aspx", "添加首页商品", 975, null);
        }
    </script>
</asp:Content>
                    ...
                    <asp:TemplateField HeaderText="商品名称" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            ...
                            <div style="float: left;">
                                <span class="Name"><a href='<%#"/appshop/ProductDetails.aspx?productId="+Eval("ProductId")%>'
                                    target="_blank">
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                        ...
                        <ItemTemplate>
                            <span class="submit_shanchu">
                                <Hi:ImageLinkButton runat="server" ID="Delete" Text="删除" DeleteMsg="确认要执行该删除操作吗？" IsShow="true" CommandName="Delete"></Hi:ImageLinkButton></span>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </UI:Grid>
