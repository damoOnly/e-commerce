<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditIosVersion.aspx.cs" Inherits="EcShop.UI.Web.Admin.App.EditIosVersion" %>
        ...
        <div class="formitem validator1">
            <ul>
                <li><span class="formitemtitle Pw_198">版本号：</span>
                   <asp:TextBox ID="txtVersion" TextMode="MultiLine" runat="server"  />
                </li>
