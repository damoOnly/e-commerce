<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="SupplierAddAppNewProduct.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierAddAppNewProduct" %>
...
<div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1 id="h1title">添加新品推荐</h1>
            <span id="spanTitle" class="font">添加新品推荐</span>
      </div>
          <div class="formitem validator2">
            <ul>
              <li><span class="formitemtitle Pw_100">新品推荐描述：</span>
