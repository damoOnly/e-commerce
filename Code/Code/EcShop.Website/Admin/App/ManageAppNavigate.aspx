<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ManageAppNavigate.aspx.cs" Inherits="EcShop.UI.Web.Admin.ManageAppNavigate" %>
...
<div class="dataarea mainwidth databody">
  ...
  <span>如果您选择了首页带有专区的模板，您需要在此配置好相关参数。</span></div>  
		<!-- 添加按钮-->
   <div class="btn">  <a class="submit_jia" href="javascript:DialogFrame('App/AddAppNavigate.aspx?id=0','添加一个专区',null,600)">添加一个专区 </a></div>
  ...
  <UI:Grid ID="grdNavigate" DataKeyNames="Id" runat="server" ShowHeader="true" 
          ...
          Width="100%" onrowcommand="grdNavigate_RowCommand">
                    ...
                    <asp:TemplateField HeaderText="图标" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <span class="Name" name="icon"><img src='<%#((NavigateInfo)Container.DataItem).ImageUrl==""?"/utility/pics/none.gif":((NavigateInfo)Container.DataItem).ImageUrl%>'  width="50px" height="50px;"/> <%--<img src='<%#GetImageUrl(((NavigateInfo)Container.DataItem).ImageUrl)%>'  width="50px" height="50px;"/>--%></span>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <UI:SortImageColumn HeaderText="排序" ItemStyle-Width="60px" ReadOnly="true" HeaderStyle-CssClass="td_right td_left"/>
                     <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                         <ItemTemplate>
                               <span class="submit_bianji"> <a  href="javascript:DialogFrame('<%# "App/AddAppNavigate.aspx?Id="+ ((NavigateInfo)Container.DataItem).Id %>','编辑专区',null,null)">编辑</a> </span>
