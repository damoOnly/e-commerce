<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierAddAppBanner.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierAddAppBanner" %>
...
<div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1 id="h1title">添加广告图</h1>
            <span id="spanTitle" class="font">添加广告图</span>
      </div>
          <div class="formitem validator2">
            <ul>
              <li><span class="formitemtitle Pw_100">广告图描述：</span>
