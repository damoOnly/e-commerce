<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="SupplierAddAppNavigate.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierAddAppNavigate" %>
...
<div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1 id="h1title">添加专区</h1>
            <span id="spanTitle" class="font">添加专区</span>
      </div>
          <div class="formitem validator2">
            <ul>
              <li><span class="formitemtitle Pw_100">专区描述：</span>
