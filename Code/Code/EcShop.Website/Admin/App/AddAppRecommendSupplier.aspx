<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="AddAppRecommendSupplier.aspx.cs" Inherits="EcShop.UI.Web.Admin.App.AddAppRecommendSupplier" %>
...
<div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1 id="h1title">添加推荐商家</h1>
            <span id="spanTitle" class="font">添加推荐商家</span>
      </div>
          <div class="formitem validator2">
            <ul>
              <li><span class="formitemtitle Pw_100">推荐商家描述：</span>
