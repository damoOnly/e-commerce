<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierAppHomeTopicSetting.aspx.cs"  Inherits="EcShop.UI.Web.Admin.App.SupplierAppHomeTopicSetting" %>
...
<script type="text/javascript">
    function ShowAddDiv() {
        DialogFrame("./App/SupplierAppSearchHomeTopic.aspx", "添加首页专题", 975, null);
    }
</script>
</asp:Content>
            ...
            <Columns> 
                    ...
                    <asp:TemplateField HeaderText="专题标题"  ItemStyle-Width="30%" HeaderStyle-CssClass="td_right td_left">
                     ...
                     <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff" HeaderStyle-Width="10%">
                        <ItemStyle />
                        <itemtemplate> 
			                <span class="submit_shanchu"><Hi:ImageLinkButton  runat="server" ID="Delete" Text="删除" DeleteMsg="确认要执行该删除操作吗？"  IsShow="true" CommandName="Delete" ></Hi:ImageLinkButton></span>
                        </itemtemplate>
                    </asp:TemplateField>
            </Columns>
        </UI:Grid>
