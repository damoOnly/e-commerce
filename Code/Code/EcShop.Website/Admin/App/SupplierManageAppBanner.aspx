<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierManageAppBanner.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierManageAppBanner" %>
...
<div class="dataarea mainwidth databody">
  ...
  <span>如果您选择了首页带有广告图的模板，您需要在此配置好相关参数。</span></div>  
		<!-- 添加按钮-->
   <div class="btn">
       <a class="submit_jia" href="javascript:DialogFrame('App/SupplierAddAppBanner.aspx?id=0','添加广告',null,null)">添加广告 </a>
 </div>
          ...
          Width="100%" onrowcommand="grdBanner_RowCommand">
                    ...
                    <UI:SortImageColumn HeaderText="排序" ItemStyle-Width="60px" ReadOnly="true" HeaderStyle-CssClass="td_right td_left"/>
                     <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                         <ItemTemplate>
                            <span class="submit_bianji"> <a  href="javascript:DialogFrame('<%# "App/SupplierAddAppBanner.aspx?Id="+ ((BannerInfo)Container.DataItem).Id %>','编辑广告图',null,null)">编辑</a> </span>
