<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SelectOneProduct.aspx.cs" Inherits="EcShop.UI.Web.Admin.SelectOneProduct" %>
...
<script language="javascript" type="text/javascript">
    function AddBindProduct() {
        ...
        var checkedproduct = chks[0];

        $(origin.document.getElementById("productid")).val(chks[0].value);
        //arr = checkedproduct.val().split('|');
        var proname = $(chks[0]).parent().parent().find("span[class='Name']").text();
         
        $(origin.document.getElementById("productName")).text(proname);
