<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierManageAppHotProduct.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierManageAppHotProduct" %>
...
<div class="dataarea mainwidth databody">
  ...
  <h1></h1>
  <span>如果您选择了首页带有商品热卖的模板，您需要在此配置好相关参数。</span></div>  
		<!-- 添加按钮-->
   <div class="btn">  <a class="submit_jia" href="javascript:DialogFrame('App/SupplierAddAppHotProduct.aspx?id=0','添加一个热卖商品',null,600)">添加一个热卖商品 </a></div>
          ...
          Width="100%" onrowcommand="grdHotSale_RowCommand">
                    ...
                    <UI:SortImageColumn HeaderText="排序" ItemStyle-Width="60px" ReadOnly="true" HeaderStyle-CssClass="td_right td_left"/>
                     <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                         <ItemTemplate>
                               <span class="submit_bianji"> <a  href="javascript:DialogFrame('<%# "App/SupplierAddAppHotProduct.aspx?Id="+ ((HotSaleInfo)Container.DataItem).Id %>','编辑热卖商品',null,null)">编辑</a> </span>
