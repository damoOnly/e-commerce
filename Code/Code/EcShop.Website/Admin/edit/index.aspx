<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="EcShop.UI.Web.Admin.edit.index" %>
<script type="text/template" id="pop_template">
  <div class="popover left"><div class="arrow"></div>
...
<script type="text/template" id="add_field_template">
        <div class="app-add-field">
                    <h4>添加内容</h4>
                    <ul>
                        <li><a class="js-new-field" data-field-type="nav_link">导航<br/>按钮</a></li>
        ...
        <div class="app-entry">
            ...
            <div class="app-fields js-fields-region">
                <div id="app-fields" class="app-fields ui-sortable">
                    ...
                    <footer class="sku-wrap" id="sku-wrap">
                        <section class="sku-con" id="sku-con">
                            <div class="sku-inner">
                                ...
                                <div class="sku-info clearfix"><img id="control_item_info_img" width="50" height="50" src="resource/default/image/lazy.png"> <span class="price">¥<span id="spSalaPrice">0.00</span></span>
                    ...
                    <footer id="footer" class="cfooter"> <a href="/Vshop/" class="selected"> <span> <i class="glyphicon glyphicon-home"></i>
                        <label>首页</label>
...
<div class="review-tip"><h3>预览</h3></div>
<div class="review">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="page-wrap"></div>--> 
                	<div class="search-wrap clearfix mb10"><!--<div class="search-con fr"><button class="btn fr" id="test-search">搜索</button><input type="text" class="search" id="test-search-input"/></div>--><h3 class="lh30">请选择</h3></div>
                        <div class="ui-box">
                        	<table class="table" id="btable">
                                <thead>
                                    <tr>
                                        <th style="width:15%;"> <div class="td-cont"> <span>图片</span> </div>
                                        </th>
                                        <th style="width:30%;"> <div class="td-cont"> <span>描述</span> </div>
                                        </th>
                                        <th style="width:35%;"> <div class="td-cont"> <span>链接</span> </div>
                                        </th>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="title"><div class="td-cont"> <a target="_blank" class="new_window clearfix" href="http://wap.koudaitong.com/v2/showcase/goods?alias=19hzmplz2"><span class="img"><img src="http://imgqn.koudaitong.com/upload_files/2015/04/17/FuwJYvmA3kWBM421vZw-gMIqV1dT.jpg" /></span></a> </div></td>
                                        ...
                                        <td class="time"><div class="td-cont"> <span>http://www.baidu.com</span> </div></td>
                                        <td class="opts"><div class="td-cont">
                    ...
                    <div id="goodmain">
                        ...
                        <div class="ui-box">
                            <table class="table" id="table">
                                <thead>
                                    <tr>
                                        <th class="title"> <div class="td-cont"> <span>商品</span> </div>
                                        </th>
                                        <th class="time"> <div class="td-cont"> <span>创建时间</span> </div>
                                        </th>
                                        <th class="opts"> 操作按钮 </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="title"><div class="td-cont"> <a target="_blank" class="new_window clearfix" href="http://wap.koudaitong.com/v2/showcase/goods?alias=19hzmplz2"><span class="img"><img src="http://imgqn.koudaitong.com/upload_files/2015/04/17/FuwJYvmA3kWBM421vZw-gMIqV1dT.jpg" /></span><span class="good-name">美国童年时光钙镁锌</span></a> </div></td>
                                        <td class="time"><div class="td-cont"> <span>2015-04-17<br>
                                                16:52:03</span> </div></td>
                                        <td class="opts"><div class="td-cont">
                                                <button class="btn js-choose" href="javascript:void(0);">选取</button>
                                            </div></td>
                                    </tr>
