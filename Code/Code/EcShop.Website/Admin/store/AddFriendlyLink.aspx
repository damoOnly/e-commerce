<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddFriendlyLink.aspx.cs" Inherits="EcShop.UI.Web.Admin.AddFriendlyLink" %>
...
<div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1>添加友情链接</h1>
            <span>管理商城的所有友情链接，您可以添加、修改或删除友情链接</span>
        </div>
      <div class="formitem validator4">
        <ul>
          <li><span class="formitemtitle Pw_110"><em >*</em>网站名称：</span>
          ...
          <asp:FileUpload ID="uploadImageUrl" Width="281" runat="server"  CssClass="forminput" style=" cursor:pointer"/>
          </li>
