<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="FriendlyLinks.aspx.cs" Inherits="EcShop.UI.Web.Admin.FriendlyLinks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
 <div class="dataarea mainwidth databody">
    <div class="title"> <em><img src="../images/01.gif" width="32" height="32" /></em>
      <h1>友情链接管理</h1>
    <span>管理商城的所有友情链接，您可以添加、修改或删除友情链接</span></div>
    <!-- 添加按钮-->
