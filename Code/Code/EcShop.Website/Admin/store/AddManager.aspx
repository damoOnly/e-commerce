<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddManager.aspx.cs" Inherits="EcShop.UI.Web.Admin.AddManager" %>
...
<div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1>添加新的管理员</h1>
            <span>将管理员添加到不同的部门，让不同部门的管理员协同管理商城</span>
          </div>
        ...
        <ul>
          <li> <span class="formitemtitle Pw_110"><em >*</em>用户名：</span>
            ...
            <p id="ctl00_contentHolder_txtUserNameTip">用户名不能为空，必须为数字或汉字或是字母开头,且在3-20个字符之间</p>
          </li>
            <li> <span class="formitemtitle Pw_110"><em >*</em>姓名：</span>
            <asp:TextBox ID="txtName" runat="server" CssClass="forminput" />
                <p id="ctl00_contentHolder_txtNameTip">姓名不能为空，必须为数字或汉字或是字母开头,且在3-20个字符之间</p>
          </li>
...
<script type="text/javascript" language="javascript">
    function InitValidators() {
        initValid(new InputValidator('ctl00_contentHolder_txtUserName', 3, 20, false, '[\u4e00-\u9fa5a-zA-Z]+[\u4e00-\u9fa5_a-zA-Z0-9]|[0-9]*', '用户名不能为空，必须为数字或汉字或是字母开头,且在3-20个字符之间'))
        initValid(new InputValidator('ctl00_contentHolder_txtName', 3, 20, false, '[\u4e00-\u9fa5a-zA-Z]+[\u4e00-\u9fa5_a-zA-Z0-9]|[0-9]*', '姓名不能为空，必须为数字或汉字或是字母开头,且在3-20个字符之间'))
