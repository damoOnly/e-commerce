<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Votes.aspx.cs"  Inherits="EcShop.UI.Web.Admin.Votes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="server">
  ...
  <div class="dataarea mainwidth databody">
    <div class="title"> <em><img src="../images/01.gif" width="32" height="32" /></em>
      <h1>投票调查管理 </h1>
     <span>管理商城的在线投票调查，您可以新建投票或查看原有投票数据。这里允许创建多个投票调查，但只能设定一个在前台显示</span></div>
    <!-- 添加按钮-->
    <div class="datalist">
    ...
    <asp:DataList ID="dlstVote" runat="server" Width="100%" DataKeyField="VoteId">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr class="table_title">
                      ...
                      <th width="22%" class=" td_left td_right_fff">操作 </td>
                    </tr>
            </HeaderTemplate>
            <ItemTemplate>
              <tr>
                ...
                <td>
                   <span class="submit_bianji"><a href='<%# Globals.GetAdminAbsolutePath("/store/EditVote.aspx?VoteId=" + Eval("VoteId"))%> '>编辑</a></span>
