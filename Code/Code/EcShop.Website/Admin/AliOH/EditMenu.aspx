<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditMenu.aspx.cs" Inherits="EcShop.UI.Web.Admin.AliOH.EditMenu"  MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" language="javascript">
        function InitValidators() {
            initValid(new InputValidator('ctl00_contentHolder_txtMenuName', 1, 12, false, null, '必填 菜单名称不能为空，一级菜单最多4个汉字，二级菜单最多12个汉字。'))
        }
