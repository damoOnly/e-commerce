<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="HomeProductSetting.aspx.cs" Inherits="EcShop.UI.Web.Admin.AliOH.HomeProductSetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript">
        function ShowAddDiv() {
            DialogFrame("./AliOH/SearchHomeProduct.aspx", "添加首页商品", 975, null);
        }
    </script>
</asp:Content>
                    ...
                    <asp:TemplateField HeaderText="商品名称" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <div style="float: left; margin-right: 10px;">
                                <a href='<%#"/AliOH/ProductDetails.aspx?productId="+Eval("ProductId")%>' target="_blank">
                                    <Hi:ListImage ID="ListImage1" runat="server" DataField="ThumbnailUrl40" />
                                </a>
                            </div>
                            <div style="float: left;">
                                <span class="Name"><a href='<%#"/AliOH/ProductDetails.aspx?productId="+Eval("ProductId")%>'
                                    target="_blank">
