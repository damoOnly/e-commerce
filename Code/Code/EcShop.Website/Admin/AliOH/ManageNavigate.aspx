<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ManageNavigate.aspx.cs" Inherits="EcShop.UI.Web.Admin.AliOH.ManageNavigate" %>
...
<div class="dataarea mainwidth databody">
  ...
  <span>如果您选择了首页带有图标的模板，您需要在此配置好相关参数。</span></div>  
		<!-- 添加按钮-->
   <div class="btn">  <a class="submit_jia" href="javascript:DialogFrame('AliOH/AddNavigate.aspx','添加一个图标',null,600)">添加一个图标 </a></div>
...
<%#((NavigateInfo)Container.DataItem).LocationType == LocationType.Phone ? ((NavigateInfo)Container.DataItem).Url : ((NavigateInfo)Container.DataItem).LoctionUrl%>
                    ...
                    <UI:SortImageColumn HeaderText="排序" ItemStyle-Width="60px" ReadOnly="true" HeaderStyle-CssClass="td_right td_left"/>
                     <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                         <ItemTemplate>
                               <span class="submit_bianji"> <a  href="javascript:DialogFrame('<%# "AliOH/EditNavigate.aspx?Id="+ ((NavigateInfo)Container.DataItem).Id %>','编辑图标',null,null)">编辑</a> </span>
