<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.AliOH.AliOHOffLinePaySet"
    CodeBehind="AliOHOffLinePaySet.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
            ...
            <div class="formitem validator1">
                <ul>
                    <li>
                        <h2 class="colorE">
                            线下支付</h2>
                        <span>请填写您的线下付款方式说明，如银行卡转账，支付宝转账等。</span><br />
                        <div>
                            例如：【支付宝 test@aplipay.com 张三】 或者 【工商银行 5855518888888888855 张三】</div>
                    </li>
                    <li class="clearfix"><span class="formitemtitle Pw_198"></span>
