<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AliOHServerConfig.aspx.cs" Inherits="EcShop.UI.Web.Admin.AliOH.WebForm1" MasterPageFile="~/Admin/Admin.Master" %>
            ...
            <div class="formitem validator1">
                <ul>
                    ...
                    <li><span class="formitemtitle Pw_198">开发者公钥：</span>
                        <asp:TextBox ID="txtPubKey" ClientIDMode="Static" runat="server" Enabled="false" Width="450" Height="100" TextMode="MultiLine"></asp:TextBox>
                        <input type="button" id="copyPubKey" value="复制" />
                    </li>
                </ul>
