<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SetVThemes.aspx.cs" Inherits="EcShop.UI.Web.Admin.AliOH.SetVThemes" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server" ClientIDMode="Static">
    <div class="dataarea mainwidth databody">
        <div class="title">
            ...
            <span>支付宝服务窗的页面风格，您可以设置当前模板相关配置参数</span>
        </div>
        <div class="datafrom">
                ...
                <ul>
                    ...
                    <li><span class="formitemtitle Pw_198">专题页最多显示商品数：</span>
                        ...
                        <p id="txtTopicProductMaxNumTip" runat="server">
                            专题页最多显示商品数不能为空,必须在0-100之间</p>
                    </li>
                    <li style="display:none;"><span class="formitemtitle Pw_198">商品列表页最多显示商品数：</span>
                        <asp:TextBox ID="txtCategoryProductMaxNum" runat="server" CssClass="forminput"></asp:TextBox>
                        <p id="txtCategoryProductMaxNumTip" runat="server">
                            商品列表页最多显示商品数不能为空,必须在0-100之间</p>
                    </li>
                    <li>
                        <h2 class="colorE">
                            背景图片设置</h2>
                    ...
                    <li style="display:none"><span class="formitemtitle Pw_198">市场价：</span>
                        <asp:TextBox ID="txtMarketPrice" runat="server" CssClass="forminput"></asp:TextBox>
                    </li>
                    <li style="display:none"><span class="formitemtitle Pw_198">售价：</span>
                    ...
                    <li style="display:none"><span class="formitemtitle Pw_198">电话：</span>
                        <asp:TextBox ID="txtPhone" runat="server" CssClass="forminput"></asp:TextBox>
                    </li>
                    <li style="display:none"><span class="formitemtitle Pw_198">导航：</span>
                        <asp:TextBox ID="txtNavigate" runat="server" CssClass="forminput" Width="200px"></asp:TextBox>
                        <a target="_blank" href="http://www.ecdev.cn/bbs/thread-193492-1-1.html">获取导航地址</a>
                    </li>
                </ul>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript">
        function InitValidators() {
            ...
            initValid(new InputValidator('txtCategoryProductMaxNum', 1, 100, false, '-?[0-9]\\d*', '商品列表页最多显示商品数不能为空,必须在0-100之间'));
            appendValid(new NumberRangeValidator('txtCategoryProductMaxNum', 0, 100, '商品列表页最多显示商品数不能为空,必须在0-100之间'));
        }
