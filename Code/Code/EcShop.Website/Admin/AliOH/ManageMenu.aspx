<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageMenu.aspx.cs" Inherits="EcShop.UI.Web.Admin.AliOH.ManageMenu"  MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="dataarea mainwidth databody">
  ...
  <h1>自定义菜单配置</h1>
  <span>自定义菜单能够帮助服务窗丰富界面，让用户更好更快地理解服务窗的功能。</span></div>  
	<div class="btn">	
   <span style="margin-right:13px;">目前自定义菜单最多包括3个一级菜单，每个一级菜单最多包含5个二级菜单。一级菜单最多4个汉字，二级菜单最多12个汉字，多出来的部分将会以“...”代替</span></btn>
   </div>
...
<!--结束-->
  ...
  <UI:Grid ID="grdMenu" DataKeyNames="MenuId" runat="server" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    ...
                    <UI:SortImageColumn HeaderText="排序" ItemStyle-Width="60px" ReadOnly="true" HeaderStyle-CssClass="td_right td_left"/>
                     <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                         <ItemTemplate>
                            ...
                            <span class="submit_shanchu"><Hi:ImageLinkButton ID="ImageLinkButton1" runat="server" IsShow="true" Text="删除" CommandName="DeleteMenu"  DeleteMsg="删除分类会级联删除其所有子分类，确定要删除选择的分类吗？" /></span>
	...
	<div style="margin-top:10px;"><asp:Button ID="btnSubmit" runat="server"  Text="保存到服务窗"  CssClass="submit_DAqueding" /></div>
