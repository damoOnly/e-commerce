<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ManageVThemes.aspx.cs" Inherits="EcShop.UI.Web.Admin.AliOH.ManageVThemes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="title"> 
      ...
      <h1>您正在使用<span style="color:red; font-size:18px;margin:0px 10px;" id="spanThemeName"><asp:Literal ID="litThemeName" runat="server"></asp:Literal></span>模板</h1>
		<span>支付宝服务窗的页面风格，好比实体店面的装修，您可以从以下列表中选择您喜欢的风格</span>
    </div>
