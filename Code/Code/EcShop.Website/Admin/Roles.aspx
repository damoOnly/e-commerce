<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Roles.aspx.cs" Inherits="EcShop.UI.Web.Admin.Roles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
	...
	<div class="dataarea mainwidth databody">
     <div class="title">
          ...
          <span>如果需要为商城添加多个管理员，则可以在划分部门以后，将管理员加入到各自的部门</span>
	</div>
    <!--数据列表区域-->
    <div class="datalist">
      <!--搜索-->
                       ...
                       <Columns>
                            ...
                            <asp:TemplateField HeaderText="部门名称" HeaderStyle-CssClass="td_right td_left">
                             ...
                             <asp:TemplateField HeaderText="操作" ItemStyle-Width="35%" HeaderStyle-CssClass="td_left td_right_fff">
                                 <ItemTemplate>
			                          <span id="submit_add" class="submit_tiajia"><a href='<%# Globals.GetAdminAbsolutePath("/store/RolePermissions.aspx?roleId=" + Eval("RoleID"))%> '>部门权限</a></span>
                                      ...
                                      <span class="submit_bianji"><a href='<%# Globals.GetAdminAbsolutePath("/store/roleManager.aspx?roleId=" + Eval("RoleID"))%> '>该部门下的员工</a></span>
                                 </ItemTemplate>                               
                             </asp:TemplateField>  
                      </Columns>
                </UI:Grid>
