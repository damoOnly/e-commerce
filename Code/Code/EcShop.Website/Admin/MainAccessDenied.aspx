<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Admin.Master" CodeBehind="MainAccessDenied.aspx.cs" Inherits="EcShop.UI.Web.Admin.MainAccessDenied" %>
...
<div id="mainhtml">	  
	        <div class="c_right">
	            <h4>
                    ...
                    <div class="middle">　　<asp:Literal runat="server" ID="litMessage" /></div>
	        </div>
    </div>
</asp:Content>