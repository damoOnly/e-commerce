<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.EditHSCode" MasterPageFile="~/Admin/Admin.Master" MaintainScrollPositionOnPostback="true" %>
                        ...
                        <td width="50%">
                            <ul>
                                <li>
                                    ...
                                    <p id="txtHSCodeTip" runat="server" style="width: 270px;">海关编码长度限制在1-32个字符之间</p>
                                </li>
                             </ul>
                        </td>
                        <td width="50%">
                        ...
                        <td>
                            <ul>
                                <li>
                                    ...
                                    <p id="txtTempInRateTip" runat="server" style="width: 270px;">长度限制在1-30个字符之间</p>
                                </li>
                            </ul>
                        </td>
                        <td>
