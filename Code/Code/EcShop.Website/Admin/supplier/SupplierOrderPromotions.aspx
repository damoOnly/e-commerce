<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierOrderPromotions.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierOrderPromotions" Title="无标题页" %>
...
<div class="dataarea mainwidth databody">
    ...
    <div class="btn">
        <asp:HyperLink runat="server" NavigateUrl="SupplierAddOrderPromotion.aspx" ID="hlinkAddPromotion" Text="添加新的订单促销" CssClass="submit_jia" />
    </div>
    <div class="datalist">    
        <div>
            <UI:Grid ID="grdPromoteSales" runat="server" AutoGenerateColumns="false"  DataKeyNames="ActivityId" Width="100%" GridLines="None" HeaderStyle-CssClass="table_title" >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                            <itemstyle width="100"  />
                            <itemtemplate>  
                                 <span class="submit_chakan"><a href='<%# Globals.GetAdminAbsolutePath(string.Format("/supplier/SupplierEditOrderPromotion.aspx?ActivityId={0}", Eval("ActivityId")))%>' >编辑</a></span>
