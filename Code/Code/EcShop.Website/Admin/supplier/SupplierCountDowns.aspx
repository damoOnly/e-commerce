<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierCountDowns.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierCountDowns" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
  ...
  <span>限时抢购活动</span>
		...
		<!--结束-->
	    <div class="btn">
          <a href="SupplierAddCountDown.aspx" class="submit_jia">添加限时抢购活动</a>
	    </div>
		<!--数据列表区域-->
	  <div class="datalist">
...
<div class="functionHandleArea clearfix m_none">
            ...
            <Columns>                 
                 ...
                 <asp:TemplateField HeaderText="操作" ItemStyle-Width="15%" HeaderStyle-CssClass="td_left td_right_fff" >
                     <ItemTemplate>
                         <span class="submit_bianji"><a href='<%# "SupplierEditCountDown.aspx?CountDownId=" + Eval("CountDownId")%> '>编辑</a></span>
