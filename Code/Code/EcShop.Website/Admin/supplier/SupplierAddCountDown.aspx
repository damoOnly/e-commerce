<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierAddCountDown.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierAddCountDown" %>
...
<script type="text/javascript" src="suppliergroupbuy.helper.js"></script>
...
<div class="areacolumn clearfix">
      ...
      <li>
         <asp:Button ID="btnAddCountDown" runat="server" Text="添加" OnClientClick="return PageIsValid();"  CssClass="submit_DAqueding"  />
         </li>
        </ul>
      </div>
  </div>
