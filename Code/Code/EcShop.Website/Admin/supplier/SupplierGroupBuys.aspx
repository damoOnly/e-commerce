<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierGroupBuys.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierGroupBuys" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
	...
	<div class="dataarea mainwidth databody">
		...
		<!--结束-->
	    <div class="btn">
          <a href="SupplierAddGroupBuy.aspx" class="submit_jia">添加团购活动</a>
	    </div>
		<!--数据列表区域-->
	  <div class="datalist">
...
<div class="functionHandleArea clearfix m_none">
            ...
            <Columns>                 
                 ...
                 <asp:TemplateField HeaderText="操作" ItemStyle-Width="10%" HeaderStyle-CssClass="td_left td_right_fff" >
                     <ItemTemplate>
                         <span class="submit_bianji"><a href='<%# "SupplierEditGroupBuy.aspx?GroupBuyId=" + Eval("GroupBuyId")%> '>编辑</a></span>
