<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="SupplierTopicList.aspx.cs" Inherits="EcShop.UI.Web.Admin.Supplier.SupplierTopicList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    <div class="dataarea mainwidth databody">
        <div class="title">
            ...
            <h1>专题管理</h1>
            <span>移动端(包括微商城,APP,触屏版,服务窗)专题管理</span>
        </div>
        <!-- 添加按钮-->
        <!--结束-->
        <!--数据列表区域-->
        <div class="datalist">
            <div class="searcharea clearfix br_search singbtn">
                <span class="signicon"></span><a href="AddSupplierTopic.aspx">添加新专题</a>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href='<%# "../../admin/Supplier/EditSupplierTopic.aspx?TopicId=" + Eval("Topicid")%> ' class="SmallCommonTextButton">编辑</a>
                            ...
                            <a href='<%# Globals.GetAdminAbsolutePath(string.Format("/Supplier/SetSupplierTopicProducts.aspx?TopicId={0}", Eval("topicId")))%>'>关联商品</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
