<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditMySupplierInfo.aspx.cs" Inherits="EcShop.UI.Web.Admin.EditMySupplierInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function PageIsValid() {
            ...
            var regphone = /^\d{1,12}-?\d{1,15}-?\d{1,15}$/; ///^(\d{3,4}\-)?[1-9]\d{6,7}$/;
            if (phone != "") {
        ...
        <div class="columnright">
            ...
            <div class="formitem validator1">
                <ul>
                    ...
                    <li style="display:none;"><span class="formitemtitle Pw_198">审核开关：</span>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var fmSrc1 = $("#fmSrc1").val();
            var fmSrc2 = $("#fmSrc2").val();
            var fmSrc3 = $("#fmSrc3").val();
            if (fmSrc1 == null || fmSrc1 == "") {
