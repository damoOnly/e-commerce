<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierSetPromotionProducts.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierSetPromotionProducts" Title="无标题页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript">
        function ShowAddDiv() {
            ...
            var supplierId = $("#ctl00_contentHolder_hdsupplierid").val().replace(/\s/g, "");
            if (activId != "" && parseInt(activId) > 0) {
                DialogFrame("supplier/SupplierSearchPromotionProduct.aspx?activityId=" + activId + "&supplierId=" + supplierId, "添加促销商品", 975, null);
            }
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <input type="hidden" id="hdsupplierid" runat="server" />
