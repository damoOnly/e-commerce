<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierEditOrderPromotion.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierEditOrderPromotion" Title="无标题页" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function Valid() {
            ...
            if (promoteType == 11) {
                ...
                //if (!exp.test(condition) || isNaN(parseFloat(condition)) || parseFloat(condition) <= 1) {
                    ...
                    <ul>
                        ...
                        <li id="liPromoteTypeDiscount" style="display: none; margin-bottom: 0px;">
                            <table>
                                <tr>
                                    <td>
                                        <div id="spCondition"><span id="lblConditionTip" class="formitemtitle Pw_110"></span>
                                            <asp:TextBox ID="txtCondition" runat="server" CssClass="forminput"></asp:TextBox></div>
                                    </td>
                                    <td>
                                        <div id="spDiscountValue"><span id="lblDiscountValueTip" style="clear: none; width: 230px;" class="formitemtitle Pw_110"></span>
                                            <asp:TextBox ID="txtDiscountValue" runat="server" CssClass="forminput"></asp:TextBox></div>
                                    </td>
                                </tr>
                            </table>
