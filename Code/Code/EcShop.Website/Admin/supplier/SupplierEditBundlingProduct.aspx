<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierEditBundlingProduct.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierEditBundlingProduct" %>
<%@ Register Assembly="EcShop.UI.SaleSystem.Tags" Namespace="EcShop.UI.SaleSystem.Tags" TagPrefix="Hi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" Runat="Server">
   <script type="text/javascript" src="../js/SupplierBundlingProduct.js"></script>
