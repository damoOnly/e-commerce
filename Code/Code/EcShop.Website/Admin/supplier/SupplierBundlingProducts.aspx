<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierBundlingProducts.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierBundlingProducts" %>
		...
		<!--搜索-->
		  <div class="title">
              ...
              <span>将指定商品进行捆绑销售，实现多元化销售</span>
           		...
           		<!--结束-->
	    <div class="btn">
          <a href="SupplierAddBundlingProduct.aspx" class="submit_jia">添加捆绑商品</a>
	    </div>
		<!--数据列表区域-->
	  <div class="datalist">
...
<div class="functionHandleArea clearfix m_none">
            ...
            <Columns>                 
                 ...
                 <asp:TemplateField HeaderText="商品名称" HeaderStyle-CssClass="td_right td_left"  ItemStyle-Width="30%">
                       <ItemTemplate>
                        <a href='<%#"../../bundlingproducts.aspx?supplierid="%><%#Eval("SupplierId") %>' target="_blank"> <%#Eval("name") %>
                 ...
                 <asp:TemplateField HeaderText="操作" ItemStyle-Width="10%" HeaderStyle-CssClass="td_left td_right_fff" >
                     <ItemTemplate>
                         <span class="submit_bianji"><a href='<%# "SupplierEditBundlingProduct.aspx?bundlingid=" + Eval("bundlingID")%>'>编辑</a></span>
