<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SetDefaultAddress.aspx.cs" Inherits="EcShop.UI.Web.Admin.SetDefaultAddress" %>
		...
		<div class="datalist">
		 ...
		 <div class="pageNumber" style="float:right;"> 
		  ...
		  <div class="batchHandleArea">
		    ...
		    <UI:Grid ID="grdAddressList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="ShippingId" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_right td_left">
                        ...
                        <ItemTemplate>
                             <Hi:ImageLinkButton ID="lkbtnSetDefaultAddress" IsShow="true" runat="server" Text="设为默认地址"
                                    CommandArgument='<%# Eval("UserId") %>' CommandName="SetDefaultAddress" DeleteMsg="确认要将该地址设为默认地址"
