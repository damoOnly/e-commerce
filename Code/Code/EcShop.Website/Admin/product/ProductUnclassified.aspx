<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.ProductUnclassified" CodeBehind="ProductUnclassified.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
	<div class="dataarea mainwidth databody">
     <div class="title">
          ...
          <h1>商品扩展分类</h1>
          <span>查看商城中所有商品所属的分类及扩展分类，您可以在此对商品设置扩展分类，也可以批量转移商品的主分类及扩展分类</span>
      </div>
	  <div class="datalist">
		<!--搜索-->
