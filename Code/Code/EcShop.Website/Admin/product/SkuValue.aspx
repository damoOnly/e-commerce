<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SkuValue.aspx.cs" Inherits="EcShop.UI.Web.Admin.SkuValue" %>
...
<div>
    <div class="frame-content">
        <div id="valueStr" runat="server">      <p><span class="frame-span frame-input90">规格值名：<em>*</em></span> <asp:TextBox ID="txtValueStr" CssClass="forminput" Width="300" runat="server"  />  </p>
        <b>多个规格值可用“,”号隔开，每个值的字符数最多15个字符,不允许包含脚本标签和\/,系统会自动过滤</b>
        </div>
