<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.ManageCategories" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="dataarea mainwidth databody">
  ...
  <h1>商品分类管理</h1>
  <span>管理商城的商品分类.您可以添加、编辑、删除商品分类</span></div>  
		<!-- 添加按钮-->
