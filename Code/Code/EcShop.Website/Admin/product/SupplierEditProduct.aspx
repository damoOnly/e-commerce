<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Admin.Master"
    CodeBehind="SupplierEditProduct.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierEditProduct" %>
            ...
            <div class="formitem validator1">
                <ul>
                    ...
                    <li id="productTaxRateRow"><span class="formitemtitle Pw_198">税率：</span>
                        <abbr class="formselect">
                            <Hi:TaxRateDropDownList runat="server" ID="dropTaxRate" NullToDisplay="--请选择--" /></abbr>
                        <p>
                            该项由关务归类选择，此处无需操作。
                        </p>
                    </li>                    
                    ...
                    <li id="li_EditPurchase"  runat="server" style="display:none">
                ...
                <ul class="btntf Pa_198 clear">
                    <asp:Button runat="server" ID="btnSave" Text="保 存" OnClientClick="return doSubmit();"
    ...
    <script type="text/javascript" language="javascript">
            $(function ()
            {
                if ($("#ctl00_contentHolder_hid_Checked").val() == "1") {
                    $("#ctl00_contentHolder_li_EditPurchase").show();
                }
            })
            function PurchaseChange(obj)
            {
                if (obj == "0")
                {
                    $("#ctl00_contentHolder_li_EditPurchase").hide();
                }
                else {
                    $("#ctl00_contentHolder_li_EditPurchase").show();
                }
