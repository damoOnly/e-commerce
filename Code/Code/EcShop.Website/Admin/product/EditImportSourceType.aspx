<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditImportSourceType.aspx.cs" Inherits="EcShop.UI.Web.Admin.EditImportSourceType" %>
    ...
    <div class="areacolumn clearfix validator4">
        <div class="columnright">
            <div class="title">
                ...
                <h1>修改原产地</h1>
                <span>填写原产地信息</span>
                <asp:TextBox ID="txtImportSourceId" runat="server" Visible="false"></asp:TextBox>
            </div>
            <div class="datafrom">
             ...
             <p id="ctl00_contentHolder_txtHSCodeTip">限定在50个字符</p>
                    ...
                    <ul class="btntf Pw_110">
                        <asp:Button ID="btnAdd" runat="server" Text="修改" OnClientClick="return PageIsValid();" CssClass="submit_DAqueding inbnt" />
                    </ul>
                </div>
            </div>
        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () { 
            ...
            $('#txtCountry').val($("#<%=hidCountry.ClientID%>").val());
        });
