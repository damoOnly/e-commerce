<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="TopicList.aspx.cs" Inherits="EcShop.UI.Web.Admin.product.TopicList" %>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href='<%# Globals.GetAdminAbsolutePath(string.Format("/product/SetTopicProducts.aspx?TopicId={0}", Eval("topicId")))%>'>关联商品</a>
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
