<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierSelectCategory.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierSelectCategory" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" src="supublish.helper.js?rnd=<%=rnd %>"></script>
</asp:Content>
