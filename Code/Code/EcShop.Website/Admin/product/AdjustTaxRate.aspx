<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AdjustTaxRate.aspx.cs" Inherits="EcShop.UI.Web.Admin.product.AdjustTaxRate" Title="无标题页" %>
...
<div class="dataarea mainwidth databody">
	 <div class="title"> <em><img src="../images/01.gif" width="32" height="32" /></em>
	    <h1 class="title_line">批量修改商品税率</h1>
     ...
     <div class="datalist">
	      <UI:Grid ID="grdSelectedProducts" DataKeyNames="ProductId" runat="server" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    ...
                    <asp:TemplateField HeaderText="税率" HeaderStyle-Width="10%" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <Hi:TaxRateDropDownList runat="server" ID="dropTaxRate" NullToDisplay="--请选择--" CssClass="dropTaxRate"/>
                        </ItemTemplate>
                    </asp:TemplateField> 
                    </Columns>
           </UI:Grid>
          ...
          <table cellspacing="0" border="0" id="OperateAll" class="OperateAll">
	            <tbody>
                    <tr>
                        ...
                        设置税率：<Hi:TaxRateDropDownList runat="server" ID="dropTaxRateAll" NullToDisplay="--请选择--" />   
                     </td>
	            </tr>
            </tbody>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#ctl00_contentHolder_dropTaxRateAll").bind("change", function () {
            var taxtAllId = $(this).val();
            $(".dropTaxRate").each(function (index, elem) {
                $(elem).val(taxtAllId);
            });
       });
    });
