<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ExportToLocal.aspx.cs" Inherits="EcShop.UI.Web.Admin.product.ExportToLocal" %>
...
<div class="optiongroup mainwidth">
		<ul>
            <li class="menucurrent"><a class="optioncurrentend"><span class="optioncenter">导出为本地数据包</span></a></li>
			<li class="optionstar"><a href="exporttotb.aspx"><span>导出为淘宝数据包</span></a></li>
			<li><a href="exporttopp.aspx" class="optionnext"><span >导出为拍拍数据包</span></a></li>
		</ul>
	</div>
         ...
         <div class="functionHandleArea clearfix" style="height:70px;">
			...
			<div class="pageHandleArea" style="_width:500px;width:500px;">
				<div>导出数量：<asp:Label runat="server" ID="lblTotals"></asp:Label>件</div>
                    <ul>
<%--                        <li><span style="margin-left:10px;"><asp:CheckBox runat="server" ID="chkExportCostPrice" Text="导出成本价" /></span></li>
					    <li><span style="margin-left:10px;"><asp:CheckBox runat="server" ID="chkExportStock" Text="导出库存数量" /></span></li>--%>
					    <li><span style="margin-left:10px;"><asp:CheckBox runat="server" ID="chkExportImages" Checked="true" Text="导出商品图片(不含商品描述中的图片)" /></span></li>
                    </ul>
			</div>
