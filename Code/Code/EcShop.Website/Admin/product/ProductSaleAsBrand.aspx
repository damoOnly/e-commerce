<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.ProductSaleAsBrand" MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
 ...
 <%-- <span>查询一段时间内商品销售量和销售额，默认排序为销售量从高到低(注：统计的商品不包括成功退款订单中的商品)。</span>--%>
   ...
   <div class="searcharea clearfix ">
	  ...
	  <UI:Grid ID="grdProductSaleAsBrand" runat="server" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    <Columns>
                             <asp:BoundField HeaderText="品牌名称" DataField="BrandName" HeaderStyle-CssClass="td_right td_left"/>                                                                                                                                                                                                                                                                                                                                                                                                  
