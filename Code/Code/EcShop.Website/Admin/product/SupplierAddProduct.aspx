<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="SupplierAddProduct.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierAddProduct" %>
                ...
                <ul>
                    ...
                    <li class=" clearfix"><span class="formitemtitle Pw_198">商品实际名称：<em>*</em></span>
                     ...
                     <li class=" clearfix"><span class="formitemtitle Pw_198">商品副标题：</span>
                        <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtProductTitle" Width="350px" />
                    ...
                    <li id="salePriceRow"><span class="formitemtitle Pw_198">一口价：<em>*</em></span>
                        <Hi:TrimTextBox runat="server" CssClass="forminput" ID="txtSalePrice" />&nbsp;元<input
                            type="button" onclick="editProductMemberPrice();" value="编辑会员价" style="margin-left: 10px;" />
                    ...
                    <li id="factQtyRow"><span class="formitemtitle Pw_198">商品库存：<em>*</em></span><Hi:TrimTextBox
                        runat="server" CssClass="forminput" Text="0" ID="txtFactStock" />
                    ...
                    <li id="weightRow"><span class="formitemtitle Pw_198">商品净重：</span><Hi:TrimTextBox
                        runat="server" CssClass="forminput" ID="txtWeight" />&nbsp;克</li>

                    <li id="grossweightRow"><span class="formitemtitle Pw_198">商品毛重：</span><Hi:TrimTextBox
                    ...
                    <li>
                           <span class="formitemtitle Pw_198">是否限购：</span>
                    ...
                    <li><span class="formitemtitle Pw_198">商品销售状态：</span>
                        ...
                        <asp:RadioButton runat="server" ID="radInStock" GroupName="SaleStatus" Text="仓库中" Checked="true"></asp:RadioButton>
                    </li>
                    <li style="display:none"><span class="formitemtitle Pw_198">商品包邮： </span>
                        <asp:CheckBox ID="ChkisfreeShipping" runat="server" />
                        &nbsp;</li>
                    <li class="clearfix" id="l_tags" runat="server"><span class="formitemtitle Pw_198">商品标签定义：<br />
                        <a id="a_addtag" href="javascript:void(0)" onclick="javascript:AddTags()" class="add">添加</a></span>
                        <div id="div_tags">
                    ...
                    <li style="display: none;"><span class="formitemtitle Pw_198">会员打折：</span>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" src="supplierattributes.helper.js?v=20160314"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function InitValidators() {
            //initValid(new SelectValidator('ctl00_contentHolder_dropProductLines', false, '请选择商品所属的商品线'));
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtSku', 0, 30, true, null, '货号的长度不能超过30个字符'));
