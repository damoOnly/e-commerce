<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SelectCategory.aspx.cs" Inherits="EcShop.UI.Web.Admin.SelectCategory" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" src="publish.helper.js?rnd=<%=rnd %>"></script>
</asp:Content>
