<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PCSetTopicProducts.aspx.cs" Inherits="EcShop.UI.Web.Admin.product.PCSetTopicProducts" Title="无标题页" %>
...
<script type="text/javascript">
    function ShowAddDiv()
    {
        ...
        if (topicId != "" && parseInt(topicId) > 0) {
            DialogFrame("./product/SearchTopicProduct.aspx?topicId=" + topicId, "添加专题商品", 975, null);
        }
