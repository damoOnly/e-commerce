<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ExportToTB.aspx.cs" Inherits="EcShop.UI.Web.Admin.product.ExportToTB" %>
...
<div class="optiongroup mainwidth">
		<ul>
			<li class="optionstar"><a href="exporttolocal.aspx" class="optionnext"><span>导出为本地数据包</span></a></li>
			<li class="menucurrent"><a><span>导出为淘宝数据包</span></a></li>
			<li class="optionend"><a href="exporttopp.aspx"><span>导出为拍拍数据包</span></a></li>
		</ul>
	</div>
