<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="SuggestProducts.aspx.cs" Inherits="EcShop.UI.Web.Admin.product.SuggestProducts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript">
        function ShowAddDiv() {
            DialogFrame("./product/SearchSuggestProduct.aspx", "添加猜你喜欢商品", 975, null);
        }
    </script>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="dataarea mainwidth databody">
        <div class="title">
            ...
            <span>如果您选择了猜你喜欢带有商品的模板，您需要在此配置好相关参数。</span>
        </div>
        <!--结束-->
        <div class="btn">
            <div style="float: right; margin-right: 15px;" class="delete">
                <Hi:ImageLinkButton ID="btnDeleteAll" runat="server" Text="清空" IsShow="true" DeleteMsg="确定要清空猜你喜欢商品吗？" /></div>
            <a class="submit_jia" href="javascript:void(0)" onclick="ShowAddDiv()">添加猜你喜欢商品</a>
        ...
        <div class="datalist datalist-img">
            <UI:Grid ID="grdSuggestProducts" runat="server" ShowHeader="true" AutoGenerateColumns="false"
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                        ...
                        <ItemTemplate>
                            <span class="submit_shanchu">
                                <Hi:ImageLinkButton runat="server" ID="Delete" Text="删除" IsShow="true" DeleteMsg="确定要执行该删除操作吗？" CommandName="Delete"></Hi:ImageLinkButton></span>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </UI:Grid>
