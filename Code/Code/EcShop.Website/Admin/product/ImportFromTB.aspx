<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ImportFromTB.aspx.cs" Inherits="EcShop.UI.Web.Admin.product.ImportFromTB" Title="无标题页" %>
...
<div class="optiongroup mainwidth">
		<ul>
			<li class="optionstar"><a href="ImportFromLocal.aspx" class="optionnext"><span>从本地导入数据包</span></a></li>
...
<div class="formitem">
            <ul>
              ...
              <li> <span style="color:Red;">淘宝数据包的来源：1.B2C商城系统本身导出的淘宝数据包；2.淘宝或商品助理导出的文件，把CSV文件和图片文件夹都命名为products然后选中两个打成zip的压缩包</span></li>
              <li>
