<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AdjustBrand.aspx.cs" Inherits="EcShop.UI.Web.Admin.product.AdjustBrand" Title="无标题页" %>
...
<div class="dataarea mainwidth databody">
	 <div class="title"> <em><img src="../images/01.gif" width="32" height="32" /></em>
	    <h1 class="title_line">批量修改商品品牌</h1>
     ...
     <div class="datalist">
	      <UI:Grid ID="grdSelectedProducts" DataKeyNames="ProductId" runat="server" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    ...
                    <asp:TemplateField HeaderText="品牌" HeaderStyle-Width="10%" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                           <Hi:BrandCategoriesDropDownList runat="server" ID="dropBrandCategories" NullToDisplay="--请选择--" CssClass="dropBrand" />
                        </ItemTemplate>
                    </asp:TemplateField> 
                    </Columns>
                </UI:Grid>
               ...
               <table cellspacing="0" border="0" id="OperateAll" class="OperateAll">
	            <tbody>
                    <tr>
                        ...
                        设置品牌：<Hi:BrandCategoriesDropDownList runat="server" ID="dropBrandCategoriesAll" NullToDisplay="--请选择--" />   
                     </td>
	            </tr>
               </tbody>
             </table>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#ctl00_contentHolder_dropBrandCategoriesAll").bind("change", function () {
            var brandAllId = $(this).val();
            $(".dropBrand").each(function (index, elem) {
                $(elem).val(brandAllId);
            });
        });
    });
