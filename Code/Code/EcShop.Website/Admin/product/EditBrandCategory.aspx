<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditBrandCategory.aspx.cs" Inherits="EcShop.UI.Web.Admin.EditBrandCategory" Title="无标题页" %>
        ...
        <ul>
          ...
          <li> <span class="formitemtitle Pw_100">&nbsp;</span>
           <table width="300" border="0" cellspacing="0">
            ...
            <li> <span class="formitemtitle Pw_100">推荐品牌Logo：</span>
            <asp:FileUpload ID="fileUpload1" runat="server" CssClass="forminput" />           
               <asp:Button ID="btnUpoad1" runat="server" Text="上传" CssClass="submit_queding" />     
          </li>
          <li> <span class="formitemtitle Pw_100">&nbsp;</span>
           <table width="300" border="0" cellspacing="0">
                  <tr>
                    <td valign="middle" style="padding-top:10px;"><Hi:HiImage ID="imgBigLogo" runat="server" Width="285" Height="395" />&nbsp;<Hi:ImageLinkButton ID="btnDeleteBigLogo"  runat="server" Text="删除" IsShow="true" /></td>
                  </tr>
                  <tr><td align="left"></td></tr>
                </table>
           </li>
