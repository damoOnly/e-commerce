        ...
        <div class="datalist">
                    ...
                    <ul>
                        <li class="batchHandleButton"><span class="signicon"></span><span class="allSelect">
                            ...
                            <select id="dropBatchOperation">
                                ...
                                <option value="17">商品权重调整</option>
                                <option value="18">调整商品税率</option>
                                <option value="19">调整商品品牌</option>
                                <option value="20">调整商品原产地</option>
                            </select>
            ...
            <UI:Grid runat="server" ID="grdProducts" Width="100%" AllowSorting="true" ShowOrderIcons="true"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="SkuId" HeaderText="商品代码" HeaderStyle-CssClass="td_right td_left" ItemStyle-Width="5%" />
                        ...
                        <ItemTemplate>
                            ...
                            <div style="float: left;">
                                <span class="Name"><%# ProductDetails(Eval("IsApproved").ToString(),Eval("ProductId").ToString(),Eval("ProductName").ToString()) %>
                                    ...
                                    target="_blank">
                                    <%# Eval("ProductName") %></a>--%></span> <span class="colorC">商品编码：<%# Eval("ProductCode") %>成本：<%# Eval("CostPrice", "{0:f2}")%></span></div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="二维码" ItemStyle-Width="80" HeaderStyle-CssClass="td_right td_left">
                        <ItemTemplate>
                            <a href='<%#Eval("QRcode").ToString().Replace("~","") %>' class="tooltip" target="_blank">
                                <img src='<%#Eval("QRcode").ToString().Replace("~","") %>' alt="二维码" width="50px" height="50px" /></a>
                    ...
                    <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass=" td_left td_right_fff min_width">
                        <ItemTemplate>
                            <span class="submit_bianji"><a href="<%# "../../admin/default.html?product/EditProduct.aspx?productId="+Eval("ProductId")%>" target="_blank">编辑</a></span> <span class="submit_bianji"><a href="javascript:void(0);" onclick="javascript:CollectionProduct('<%# "EditReleteProducts.aspx?productId="+Eval("ProductId")%>')">相关商品</a></span> <span class="submit_shanchu">
            ...
            <table cellpadding="0" cellspacing="0" width="550px" border="0" class="fram-retreat">
                <tr>
                    ...
                    <td align="left" class="bd_td">
                        ...
                        <asp:Literal ID="litReferralDeduct" runat="server" /><p>推广员分享链接产生有效订单时享受的佣金比例</p>
                    </td>
                </tr>
                <tr>
                    <td align="right">下级会员佣金：</td>
                    <td align="left" class="bd_td">
                        <asp:TextBox ID="txtSubMemberDeduct" CssClass="forminput" runat="server" />&nbsp;%<asp:Literal ID="litSubMemberDeduct" runat="server" /><p>下级会员未通过分享链接进入商城时产生的订单，推广员可享受的佣金比例</p>
                    </td>
                </tr>
                <tr>
                    <td align="right">下级推广员佣金：</td>
                    <td align="left" class="bd_td">
                        <asp:TextBox ID="txtSubReferralDeduct" CssClass="forminput" runat="server" />&nbsp;%<asp:Literal ID="litSubReferralDeduct" runat="server" /><p>推广员分享链接产生有效订单时，其上级推广员也可获得相应的佣金比例</p>
                    </td>
                </tr>
            </table>
        </div>
