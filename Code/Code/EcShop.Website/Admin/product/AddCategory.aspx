<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.AddCategory" MasterPageFile="~/Admin/Admin.Master" CodeBehind="~/Admin/product/AddCategory.aspx.cs" %>
        ...
        <div class="columnright">
            ...
            <div class="formitem validator1">
                <ul>
                    ...
                    <li><span class="formitemtitle Pw_198">选择上级分类：</span>
                        <span class="formselect">
                            <Hi:ProductCategoriesDropDownList ID="dropCategories" runat="server" Width="153px" /></span>
                    </li>
                    <li><span class="formitemtitle Pw_198">商品类型：</span>
                        <span class="formselect">
                            <Hi:ProductTypeDownList runat="server" CssClass="productType" ID="dropProductTypes" Width="153px" /></span>
                    </li>
                    <li>
                    ...
                    <li><span class="formitemtitle Pw_198">分类图标：</span><asp:FileUpload ID="fileUpload" runat="server" CssClass="forminput" /></li>

                    <%--<li> <span class="formitemtitle Pw_198">税率：</span>
                <span class="formselect"><Hi:TaxRateDropDownList runat="server" CssClass="productType" ID="dropTaxRate" Width="153px" /></span>
                 <p id="ctl00_contentHolder_dropTaxRateTip">默认值为0.01</p>
              </li>--%>

                    <li><span class="formitemtitle Pw_198">货号前缀：</span>
                    ...
                    <li><span class="formitemtitle Pw_198">搜索标题：</span>
