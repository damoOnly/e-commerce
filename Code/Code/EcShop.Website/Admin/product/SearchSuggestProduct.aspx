...
<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SearchSuggestProduct.aspx.cs" Inherits="EcShop.UI.Web.Admin.product.SearchSuggestProduct" %>
...
<!--选项卡-->
  ...
  <h1>首页猜你喜欢商品添加</h1>
  <span>首页猜你喜欢商品查询，方便添加首页猜你喜欢商品</span>
        </div>
		<!--搜索-->
