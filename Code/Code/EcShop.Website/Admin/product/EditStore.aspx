<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditStore.aspx.cs" Inherits="EcShop.UI.Web.Admin.EditStore" %>
    ...
    <div class="areacolumn clearfix">
        <div class="columnright">
            ...
            <div class="formitem validator1">
                <ul>
                    <li><span class="formitemtitle Pw_198"><em>*</em>门店名称：</span>
                        <asp:TextBox ID="txtSupplierName" MaxLength="30" CssClass="forminput" runat="server" />
                        <p id="ctl00_contentHolder_txtSupplierNameTip">门店名称不能为空，长度限制在30个字符以内</p>
                    </li>
                    ...
                    <li><span class="formitemtitle Pw_198"><em>*</em>详细地址：</span>
                        ...
                        <p id="ctl00_contentHolder_txtAddressTip">门店地址不能为空，长度限制在30个字符以内</p>
                    </li>
