<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ImportFromPP.aspx.cs" Inherits="EcShop.UI.Web.Admin.product.ImportFromPP" Title="无标题页" %>
...
<div class="optiongroup mainwidth">
		<ul>
			<li class="optionstar"><a href="ImportFromLocal.aspx"><span>从本地数据包导入</span></a></li>
			<li><a href="ImportFromTB.aspx" class="optionnext"><span>从淘宝数据包导入</span></a></li>
			<li class="menucurrent"><a class="optioncurrentend"><span class="optioncenter">从拍拍数据包导入</span></a></li>
		</ul>
</div>
...
<div class="formitem">
            <ul>
              ...
              <li> <span style="color:Red;">拍拍数据包的来源：1.B2C商城系统本身导出的拍拍数据包；2.拍拍或商品助理导出的文件，把CSV文件和图片文件夹都命名为products然后选中两个打成zip的压缩包</span></li>
              <li>
              ...
              <li>
                ...
                如果上面的下拉框中没有您要导入的数据包文件，请先上传。 </span>
                </div>
              </li>
              <li> <span class="formitemtitle Pw_198">&nbsp;</span>
                <asp:FileUpload runat="server" ID="fileUploader" CssClass="forminput"/>&nbsp;&nbsp;<asp:Button runat="server" ID="btnUpload" Text="上传" />               
                  <div style="clear:both;" class="Pa_198">
                <span>
                   上传数据包须小于40M，否则可能上传失败，<br/>您还可以使用FTP工具先将数据包上传到网站的/storage/data/paipai目录以后，再重新打开此页面操作。
                </span>
                </div>
              </li>
              </ul>
