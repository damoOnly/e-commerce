<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.ProductSaleRanking" MasterPageFile="~/Admin/Admin.Master" %>
            ...
            <div class="datalist">
                ...
                <div class="searcharea clearfix ">
                    <ul class="a_none_left">
                        ...
                        <li><span>商品编码：</span><span><asp:TextBox ID="txtProductCode" runat="server" CssClass="forminput" /></span></li>
                ...
                <UI:Grid ID="grdProductSaleStatistics" runat="server" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="排行" HeaderStyle-CssClass="border_right border_top border_bottom" ItemStyle-Width="10%">
                            <ItemTemplate>
                                <asp:Image ID="Image1" runat="server" ImageUrl='<%# Convert.ToInt32(Eval("IDOfSaleTotals"))==1?"../images/0001.gif":Convert.ToInt32(Eval("IDOfSaleTotals"))==2?"../images/0002.gif":"../images/0003.gif" %>'
                                    Visible='<%#Convert.ToInt32(Eval("IDOfSaleTotals"))<4 %>' />
                                <strong><%#Eval("IDOfSaleTotals")%></strong>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="商品名称" HeaderStyle-CssClass="td_right td_left" ItemStyle-Width="30%">
                            <ItemTemplate>
                                <asp:Label ID="lblProductName" runat="Server" Text='<%#  EcShop.Core.Globals.HtmlDecode( Eval("ProductName").ToString()) %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField HeaderText="供货商" DataField="SupplierName" HeaderStyle-CssClass="td_right td_left" ItemStyle-Width="15%" />
                        <asp:TemplateField HeaderText="商家编码" HeaderStyle-CssClass="td_right td_left" ItemStyle-Width="15%">
                            <ItemTemplate>
                                <asp:Label ID="lblBuyCount" runat="Server" Text='<%# Eval("SKU") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="销售量" HeaderStyle-CssClass="td_right td_left" ItemStyle-Width="10%">
                            <ItemTemplate>
                                <asp:Label ID="lblBuyCount" runat="Server" Text='<%# Eval("ProductSaleCounts") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="销售额" HeaderStyle-CssClass="td_right td_left" ItemStyle-Width="10%">
                            <ItemTemplate>
                                <Hi:FormatedMoneyLabel ID="FormatedMoneyLabelForAdmin1" Money='<%#Eval("ProductSaleTotals") %>' runat="server"></Hi:FormatedMoneyLabel>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="利润" HeaderStyle-CssClass="td_right td_right_fff" ItemStyle-Width="10%">
                            <ItemTemplate>
