<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintComplete.aspx.cs" Inherits="EcShop.UI.Web.Admin.sales.PrintComplete" %>
...
<body>
<%= script%>
<div style=" margin-left:400px; margin-top:100px;"><input type="button" value="关闭" class="notprint submit_DAqueding" id="printBtn" onclick="closeclicks()"/></div>
</body>
</html>
