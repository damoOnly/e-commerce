<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="WxPayQrCodeSet.aspx.cs" Inherits="EcShop.UI.Web.Admin.sales.WxPayQrCodeSet" %>
...
<div class="dataarea mainwidth databody">
      <div class="title"> <em><img src="../images/01.gif" width="32" height="32" /></em>
        <h1>微信扫码支付收款信息设置</h1>
        <span>请设置好您的微信扫码支付信息。</span>
      </div>
      <div class="datafrom">
        <div class="formitem validator1">
          <ul>
            <li><h2 class="colorE">微信扫码支付</h2></li>
           <li class="clearfix"><span class="formitemtitle Pw_198">是否开启：</span>
            ...
            <li><span class="formitemtitle Pw_198">商户号：</span>
              <asp:TextBox ID="txtMchId" CssClass="forminput formwidth" runat="server" />
            </li> 
