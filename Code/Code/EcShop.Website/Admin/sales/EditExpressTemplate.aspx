<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditExpressTemplate.aspx.cs" Inherits="EcShop.UI.Web.Admin.EditExpressTemplate" Title="无标题页" %>
...
<div class="dataarea mainwidth databody">
	<div class="title">
		...
		<h1>编辑快递单</h1>
		<span>编辑快递单模板(单据名称需要与物流公司名称保持一致,<span style="color:Red">如快递单有“始发地”、“目的地”，请在下面的“单据打印项”中添加“始发地-地区”、“目的地-地区”</span> )</span>
	</div>
	<div class="datalist">
