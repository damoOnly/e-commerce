<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.SaleReport" MasterPageFile="~/Admin/Admin.Master" %>
...
<!--选项卡-->
  ...
  <h1>零售生意报告</h1>
  <span>查看网店生意情况，您可以按月或按日分别查看商城订单交易量、交易额和销售利润（需要设置商品成本价）</span>
</div>
		<!--搜索-->
            ...
            <ul class="a_none_left">
              ...
              <li>
               <li>
                <span>站点：</span>
                <abbr class="formselect">
                    <Hi:SitesDropDownList runat="server" ID="sitesDropDownLists" Width="100" AllowNull="false"/>
                </abbr>
            </li>
             <li>
                <span>订单来源：</span>
                <abbr class="formselect">
                   <asp:DropDownList ID="ddlOrderSources" runat="server" CssClass="forminput droptype" ClientIDMode="Static">
                        </asp:DropDownList>
                </abbr>
             </li> 
