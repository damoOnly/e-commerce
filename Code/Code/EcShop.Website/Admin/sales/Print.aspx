<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="EcShop.UI.Web.Admin.sales.Print" %>
...
<object  id="LODOP_OB" classid="clsid:2105C259-1E0C-4534-8141-A753534CB4CA" width=0 height=0> 
  ...
  正在打印，请勿关闭窗口。。。 
   ...
   <div id="divcloseprint" style=" display:none;  margin-top:100px;"><input type="button" value="关闭" class="notprint submit_DAqueding" id="printBtn" onclick="closeclicks()"/></div>
      </form>
