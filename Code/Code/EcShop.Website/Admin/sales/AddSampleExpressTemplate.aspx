<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddSampleExpressTemplate.aspx.cs" Inherits="EcShop.UI.Web.Admin.AddSampleExpressTemplate" Title="无标题页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
	...
	<div class="datalist">
	      <table width="80%" id="controls" height="56" border="0" cellpadding="0" cellspacing="0" style="text-align:center; border:1px #CCC solid;  background-color:#E7E7E7; font-size:12px; padding:0px;
margin:0px 0px 5px 0px;">
  <tr>
    ...
    <td width="0" class="tdline"><form name="form0" style=" padding:8px 0px 0px 0px">
					  <label>
					  </label>
					</form></td>
					<td width="0"><form name="form1" style=" padding:8px 0px 0px 0px">
					  <label></label>
					</form></td>
  </tr>
  <tr>
    <td width="128" height="30"><form name="form2">
      <label><input name="emsname" type="text" id="emsname" size="12"/></label>
    </form></td>
    <td width="52" class="tdline"><form name="form3">
      <label><button name="btndata" onClick="getData()" type="button">保存
			</button></label>
    </form></td>
    <td width="132"><form name="form4">
      <label>宽:<input name="swidth" type="text" id="widths" size="4" value="228" onchange="setfsize()"/>mm</label>
    </form></td>
    <td width="132" class="tdline"><form name="form5">
      <label>*高:<input name="sheight" type="text" id="heights" size="4" value="127" onchange="setfsize()" />mm</label>
    </form></td>
    <td width="69"><form name="form6">
      <label><button name="btnclick"
			onClick ="clickbtn();return false;">上传
			</button></label>
    </form></td>
    <td width="69" class="tdline"><form name="form7">
      <label><button name="btnimage"
			onClick ="imagebtn();return false;">删除
			</button></label>
    </form></td>
    <td width="135"><form name="form8">
      <label>
        <select 
			    name="item" 
    ...
    <td width="64" class="tdline"><form name="form9">
...
<div id="writeroot"></div>
		...
		<div id="flashoutput">
			<noscript>
				...
				<param name="src" value="../../Storage/master/flex/AddSimpleExpressTemplate.swf"/>
				<embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="../../Storage/master/flex/AddSimpleExpressTemplate.swf" height="600" width="100%" flashvars="bridgeName=example"/>
				</object>
			</noscript>
			<script language="javascript" charset="utf-8">
				...
				document.write('<param name="src" value="../../Storage/master/flex/AddSimpleExpressTemplate.swf"/>');
				document.write('<embed name="flexApp" pluginspage="http://www.macromedia.com/go/getflashplayer" src="../../Storage/master/flex/AddSimpleExpressTemplate.swf" height="600" width="100%" flashvars="bridgeName=example"/>');
