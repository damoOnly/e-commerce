<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.AddPaymentType" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="areacolumn clearfix validator4">
		<div class="columnright">
		  <div class="title"> 
		    ...
		    <h1>添加新的支付方式</h1>
		    <span>从系统现有的支付接口类型中选择添加适合商城的支付方式</span>
		  </div>
		  <div class="datafrom">
          ...
          $.ajax({
              ...
              success: function (resultData) {
                  ...
                  $.each(resultData.items, function (i, item) {
                      if (item.FullName != "ecdev.plugins.payment.ws_wappay.wswappayrequest") {// 
                  ...
                  //$(dropPlugins).append($(String.format("<option value=\"{0}\">{1}</option>", "微信扫码支付", "微信扫码支付")));
              }
          });
