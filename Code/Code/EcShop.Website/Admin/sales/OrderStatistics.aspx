<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.OrderStatistics" MasterPageFile="~/Admin/Admin.Master" %>
        ...
        <div class="datalist">
            ...
            <div class="searcharea clearfix ">
                <ul class="a_none_left">
                    <li>
                        ...
                        <abbr class="formselect">
                            <Hi:SitesDropDownList runat="server" ID="sitesDropDownList" Width="100" AllowNull="false" />
                        </abbr>
                    </li>
                    <li>
                        <span>订单来源：</span>
                        <abbr class="formselect">
                            <asp:DropDownList ID="ddlOrderSource" runat="server" CssClass="forminput droptype" ClientIDMode="Static">
                            </asp:DropDownList>
                        </abbr>
                    </li>
                ...
                <li><span>供货商：</span><span>
                    ...
                    <li>
                        <asp:Button ID="btnSearchButton" runat="server" Text="查询" class="searchbutton" /></li>
                    <li>
                        <p>
            ...
            <table cellspacing="0" border="0" id="TabOrders" style="width: 100%; border-collapse: collapse;">
                <tr class="table_title">
                    <th class="td_right td_left" scope="col">订单号</th>
                    <th class="td_right td_left" scope="col">下单时间</th>
                    <th class="td_right td_left" scope="col">总订单金额</th>
                    <th class="td_right td_left" scope="col">用户名</th>
                    <th class="td_right td_left" scope="col">收货人</th>
                    <th class="td_left td_right_fff" scope="col">利润</th>
                </tr>
                <asp:Repeater ID="rp_orderStatistics" runat="server" OnItemDataBound="rp_orderStatistics_ItemDataBound">
                    <ItemTemplate>
                        <tr style="cursor: pointer;" title="点击查看商品列表">
                            <td><%# Eval("OrderId")%></td>
                            <td>
                                <Hi:FormatedTimeLabel ID="lblStartTimes" Time='<%#Eval("OrderDate") %>' runat="server"></Hi:FormatedTimeLabel></td>
                            <td>
                                <Hi:FormatedMoneyLabel ID="FormatedMoneyLabelForAdmin1" Money='<%#Eval("Total") %>' runat="server"></Hi:FormatedMoneyLabel></td>
                            <td><%# Eval("UserName")%></td>
                            <td><%# Eval("ShipTo")%></td>
                            <td>
                                <Hi:FormatedMoneyLabel ID="FormatedMoneyLabelForAdmin2" Money='<%#Eval("Profits") %>' runat="server"></Hi:FormatedMoneyLabel></td>
                        </tr>
                        <tr class="c_hidden">
                            <td colspan="6">
                                <table width="100%">
                                    <asp:Repeater ID="rp_orderitem" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                <td><a href='<%#"../../ProductDetails.aspx?ProductId="+Eval("ProductId") %>' target="_blank">
