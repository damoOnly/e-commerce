<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ReplaceDetails.aspx.cs" Inherits="EcShop.UI.Web.Admin.ReplaceDetails" %>
    ...
    <div class="dataarea mainwidth databody">
        ...
        <div class="Purchase">
            <div class="Settlement">
                <table>
                    <tr>
                        <td><strong class="fonts colorE">当前退货单（<asp:Literal runat="server" ID="litReplaceId" />）状态：<asp:Literal runat="server" ID="litReplaceHandleStatus" /></strong>
                        </td>
                    </tr>
                    <tr>
                        <td>
                ...
                <HeaderTemplate>
                    <table width="200" border="0" cellspacing="0">
                        <tr class="table_title">
                            <td colspan="2" class="td_right td_left">退换商品名称</td>
...
<%--                    <tr>
                    ...
                    <tr>
                        <td align="right" style="width: 100px;">退货状态：</td>
                        <td>
                            <asp:Literal ID="litReplaceHandleStatus1" runat="server" />&nbsp;</td>
                    </tr>
                    <tr>
