<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="BatchSendOrderGoods.aspx.cs" Inherits="EcShop.UI.Web.Admin.sales.BatchSendOrderGoods" %>
            ...
            <Columns>
                ...
                <UI:DropdownColumn HeaderText="配送方式" ItemStyle-Width="100px" 
                 ...
                 <UI:DropdownColumn HeaderText="物流公司" ItemStyle-Width="140px"
                      JustForEditItem="false" ID="dropExpress" DataKey="ExpressCompanyName" DataTextField="Name"
                      DataValueField="Name" AllowNull="true" >
                </UI:DropdownColumn>
