<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SetOrderOption.aspx.cs" Inherits="EcShop.UI.Web.Admin.SetOrderOption" %>
...
<div class="dataarea mainwidth databody">
      ...
      <div class="datafrom">
          <div class="formitem validator1">
            ...
            <li><span class="formitemtitle Pw_198"><em >*</em>过期几小时自动关闭订单：</span>
            ...
            <li><span class="formitemtitle Pw_198"><em >*</em>完成几天自动结束交易：</span>
              <asp:TextBox ID="txtEndOrderDays" runat="server" CssClass="forminput" />
              <p id="txtEndOrderDaysTip" runat="server">订单完成几天后，系统自动结束交易，不得再申请退换货服务</p>
            </li>                 
