<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="BatchPrintData.aspx.cs" Inherits="EcShop.UI.Web.Admin.sales.BatchPrintData" %>
...
*/
        ...
        #show { display: none; position: absolute; top: 35%; left: 40%; width: 25%; height: 3%; padding: 8px; border: 8px solid #E8E9F7; background-color: white; z-index: 1002; overflow: auto; }
    </style>
        ...
        <div class="title  m_none td_bottom" style="padding: 5px 0px 5px 12px">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="80%">
                        <span style="color: Red">注意：打印时请选择默认打印机！</span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function DoPrint() {
            if (DoValid()) {
                ...
                // var url = "BatchPrintData.aspx?mailNo=" + $("#ctl00_contentHolder_txtStartCode").val() + "&template=" + $("#ctl00_contentHolder_ddlTemplates").val() + "&shipperId=" + $("#ctl00_contentHolder_ddlShoperTag").val() + "&orderIds=<%= orderIds %>";
