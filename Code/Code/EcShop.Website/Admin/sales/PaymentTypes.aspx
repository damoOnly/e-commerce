<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="PaymentTypes.aspx.cs" Inherits="EcShop.UI.Web.Admin.PaymentTypes" %>
...
<div class="dataarea mainwidth databody">
  ...
  <h1><table><tr><td>支付方式列表</td></tr></table></h1>
<span>商城当前的所有支付方式，顾客在下订单的时候将从中选择一个支付方式</span> <span style="margin-left:20px;"><a target="_blank" href="http://act.life.alipay.com/systembiz/hishop/">立即免费申请开通支付宝接口</a></span></div>
