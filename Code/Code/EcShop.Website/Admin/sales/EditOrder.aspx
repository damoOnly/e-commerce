<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditOrder.aspx.cs" Inherits="EcShop.UI.Web.Admin.EditOrder" %>
...
<div class="dataarea mainwidth databody ">
    ...
    <div class="list">
    <h1>商品列表</h1>    
      <UI:Grid ID="grdProducts" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="table_title" DataKeyNames="SkuId" SortOrderBy="SkuId" SortOrder="DESC" GridLines="None" AllowSorting="true" Width="100%">
                ...
                <asp:TemplateField HeaderText="商品" HeaderStyle-CssClass="td_right td_left">
                    <ItemTemplate>
                      ...
                      <div style="float:left;margin-left:10px;line-height:22px;"><span><a href='<%#"../../ProductDetails.aspx?ProductId="+Eval("ProductId") %>' target="_blank"><%# Eval("ItemDescription") %></a>
                       <br/>货号：<asp:Literal ID="litSku" runat="server" Text='<%# Eval("Sku") %>' /> <asp:Literal ID="litSKUContent" runat="server" Text='<%# Eval("SKUContent") %>'></asp:Literal>
                      </div>
                    </ItemTemplate>
                </asp:TemplateField>
