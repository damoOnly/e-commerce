<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintPackingOrder.aspx.cs" Inherits="EcShop.UI.Web.Admin.sales.PrintPackingOrder" %>
    ...
    <form id="form1" runat="server">
     <div class="dataarea mainwidth" style="border-style:none;">
        <div class="Order_Info">
            <table cellpadding="3" cellspacing="0" width="948px">
                <tr>
                ...
                <tr>
                    <td>支付方式：<asp:Literal ID="litPayType" runat="server" /></td>
        ...
        <div class="Order_Item">
            <div>
                <UI:Grid runat="server" ID="grdOrderItems" AutoGenerateColumns="false" Width="948px" BorderWidth="0">
                    <Columns>
                        ...
                        <asp:BoundField DataField="ItemAdjustedPrice" HeaderText="商品单价" />
                        <asp:BoundField DataField="Quantity" HeaderText="购买数量" />
                        <asp:BoundField DataField="ShipmentQuantity" HeaderText="发货数量" />
                        <asp:TemplateField HeaderText="小计">
                            <ItemTemplate>
                                <%# (decimal)Eval("ItemAdjustedPrice") * (int)Eval("Quantity")%>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </UI:Grid>
            ...
            <div>
                <UI:Grid runat="server" ID="grdOrderGifts" AutoGenerateColumns="false" Width="948px" BorderWidth="0" >
                    <Columns>
                        <asp:TemplateField HeaderText="商品图片">
                            <ItemTemplate>
                                <Hi:ListImage ID="HiImage2"  runat="server" DataField="ThumbnailsUrl" />
