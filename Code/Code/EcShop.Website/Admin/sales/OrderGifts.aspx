<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OrderGifts.aspx.cs" Inherits="EcShop.UI.Web.Admin.OrderGifts"  %>
...
<div class="Goodsgifts">
    ...
    <div class="left">
      <h1>请从下列礼品中选择</h1>
      <div style="margin-bottom:20px;"><asp:TextBox ID="txtSearchText" runat="server" CssClass="forminput" style="margin-right:10px;"/>
