<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddShippingTemplate.aspx.cs" Inherits="EcShop.UI.Web.Admin.sales.AddShippingTemplate" %>
...
function InitValidators()
{
    ...
    initValid(new InputValidator('ctl00_contentHolder_txtWeight', 1, 10, false, '(0|(0+(\\.[0-9]{1,4}))|[1-9]\\d*(\\.\\d{1,4})?)', '起步重量不能为空,必须为非负正数,限制在100千克以内'))
    appendValid(new NumberRangeValidator('ctl00_contentHolder_txtWeight', 0, 100000, ' 必须为非负数字,限制在100千克以内'));
    initValid(new InputValidator('ctl00_contentHolder_txtAddWeight', 1, 10, true, '(0|(0+(\\.[0-9]{1,4}))|[1-9]\\d*(\\.\\d{1,4})?)', '加价重量必须为正数,限制在100千克以内'))
   ...
   {  
     ...
     　　var fagtxtRegionPrice=document.getElementById("ctl00_contentHolder_txtRegionPrice").value;//起步价
     　　　var fagtxtAddRegionPrice=document.getElementById("ctl00_contentHolder_txtAddRegionPrice").value;//加价    　　　
            if (fagtxtRegion.length <= 0 || fagtxtRegion.length > 60) { alert("到达地名称不能为空，长度限制在60字符以内"); return false; }
...
<div class="areacolumn clearfix">
    ...
    <asp:Button ID="btnCreate" runat="server" OnClientClick="return PageIsValid();"  CssClass="submit_DAqueding inbnt" Text="添 加"/>
            </ul>
	      </div>
  </div>
</div>
...
<div class="bottomarea testArea">
 ...
 <div class="Pop_up" id="AddHotareaPric" style="display:none;">
  ...
  <div class="mianform">
   <ul>
    <li><span class="formitemtitle Pw_100"><em >*</em>到达地：</span>
    ...
    <li><span class="formitemtitle Pw_100"><em >*</em>起步价：</span>
   <asp:TextBox ID="txtRegionPrice" runat="server" Columns="15" Text="0" class="forminput"></asp:TextBox>              
    ...
    <li><span class="formitemtitle Pw_100"><em >*</em>加价：</span>
