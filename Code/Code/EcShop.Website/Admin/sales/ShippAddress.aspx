<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ShippAddress.aspx.cs" Inherits="EcShop.UI.Web.Admin.ShippAddress" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentHolder" runat="server">
 ...
 <div id="dlgShipTo">
    <div class="frame-content">
        ...
        <p><span class="frame-span frame-input90">身份证号码：</span><asp:TextBox ID="txtIdentityCard" runat="server" CssClass="forminput"></asp:TextBox></p>
    </div>
...
<script>
    function ValidationAddress() {
        ...
        var memberIdentityCard = document.getElementById("ctl00_contentHolder_txtIdentityCard").value;
        if (memberIdentityCard != '' && memberIdentityCard.indexof("********")<0) {
