<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="SupplierManageOrder.aspx.cs" Inherits="EcShop.UI.Web.Admin.SupplierManageOrder" %>
        ...
        <div class="datalist">
            <asp:DataList ID="dlstOrders" runat="server" DataKeyField="OrderId" Width="100%">
                ...
                <ItemTemplate>
                    <tr class="td_bg">
                        <td>
                            <input name="CheckBoxGroup" type="checkbox" value='<%#Eval("OrderId") %>' />订单编号：<%#Eval("OrderId") %><Hi:SourceOrderLable runat="server" SourceOrder='<%#Eval("SourceOrder") %>'></Hi:SourceOrderLable>
                    ...
                    <tr>
                        ...
                        <td style="color: #0B5BA5">&nbsp;
                            ...
                            <span class="Name"><a href='<%# "SupplierOrderDetails.aspx?OrderId="+Eval("OrderId") %>'>详情</a></span>
                        </td>
                        <td>&nbsp;
                            <span class="Name">
    ...
    <script type="text/javascript">
        ...
        function printGoods() {
            ...
            if (orderIds == "") {
                ...
                $.ajax({
                    ...
                    data: { action: "CheckIsPrivilege", rightname: "SupplierOrderPrintGoods" },
        ...
        function batchSend() {
            ...
            if (orderIds == "") {
                ...
                $.ajax({
                    url: "/admin/sales/OrderProcess.ashx",
                    type: 'post', dataType: 'json', timeout: 10000,
                    data: { action: "CheckIsPrivilege", rightname: "SupplierOrderBatchSend" },
                    success: function (resultData) {
                        if (resultData.Status == "OK") {
        ...
        function batchSendByExcel() {
            ...
            $.ajax({
                url: "/admin/sales/OrderProcess.ashx",
                type: 'post', dataType: 'json', timeout: 10000,
                data: { action: "CheckIsPrivilege", rightname: "SupplierOrderUploadGoods" },
                success: function (resultData) {
                    if (resultData.Status == "OK") {
