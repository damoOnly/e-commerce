<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.SendMessageSelectUser" MasterPageFile="~/Admin/Admin.Master" EnableSessionState="ReadOnly" %>
      ...
      <ul>
        <li><span class="formitemtitle Pw_100">按等级发送：</span>
           <abbr class="formselect">
                 <Hi:MemberGradeDropDownList ID="rankList" class="formselect input100" runat="server" AllowNull="true" NullToDisplay="全部" />
          </abbr>
        </li>
      </ul>
    </div>
