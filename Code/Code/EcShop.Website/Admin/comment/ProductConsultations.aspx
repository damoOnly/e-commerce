<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.ProductConsultations" MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="toptitle"> <em><img src="../images/07.gif" width="32" height="32" /></em> <span class="title_height">管理商城的所有商品咨询，您可以查询或删除商品咨询</span> </div>
    <!--搜索-->
     ...
     <UI:Grid ID="grdConsultation" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="ConsultationId" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-Width="15%" HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                            ...
                            <ItemTemplate>
                                <span class="submit_faihuo"><a href="javascript:DialogFrame('<%# Globals.GetAdminAbsolutePath(string.Format("/comment/ReplyProductConsultations.aspx?ConsultationId={0}", Eval("ConsultationId")))%>','回复客户咨询',null,null)">回复</a></span>
