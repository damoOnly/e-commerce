<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddHelpCategory.aspx.cs" Inherits="EcShop.UI.Web.Admin.AddHelpCategory" %>
...
<div class="areacolumn clearfix">
      <div class="columnright">
          <div class="title">
            ...
            <h1>添加帮助分类</h1>
            <span>建立良好的帮助文章分类，方便客户快速找到自己所需的帮助信息</span>
        </div>
