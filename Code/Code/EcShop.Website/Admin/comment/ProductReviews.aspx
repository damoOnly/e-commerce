<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.ProductReviews" MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
  ...
  <h1>商品评论管理</h1>
  <span>管理商城的所有商品评论，您可以查询或删除商品评论 </span>
</div>
		...
		<div class="pageNumber">
		  ...
		  <div class="blank8 clearfix"></div>
		   ...
		   <asp:DataList ID="dlstPtReviews" runat="server" DataKeyField="ReviewId" Style="width: 100%;" >
                ...
                <ItemTemplate>
                    <tr>
                      <td ><span class="Name"><a href='<%#string.Format("../../ProductDetails.aspx?productId={0}",Eval("productId"))%>' target="_blank"><asp:Literal ID="lblProductName" runat="server" Text='<%# Eval("ProductName") %>' /></a></span></td>
