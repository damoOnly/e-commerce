<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.SendedMessages" MasterPageFile="~/Admin/Admin.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="server">
	...
	<ul>
        <li class="optionstar"><a href="ReceivedMessages.aspx" class="optionnext"><span>收件箱</span></a></li>
    ...
    <div class="datalist">
        <UI:Grid ID="messagesList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="MessageId" GridLines="None" Width="100%" HeaderStyle-CssClass="table_title">
           <Columns>                 
                ...
                <itemstyle  CssClass="Name" />
                    <ItemTemplate>
                    <a href="javascript:DialogFrame('<%# Globals.GetAdminAbsolutePath(string.Format("/member/MemberDetails.aspx?userId={0}",Eval("AccepterUserId"))) %>','查看会员详细信息',null,null)"><%# Eval("Accepter")%></a>
                    </ItemTemplate>
                </asp:TemplateField>
