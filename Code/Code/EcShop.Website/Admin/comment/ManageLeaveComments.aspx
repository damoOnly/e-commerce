<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.ManageLeaveComments" MasterPageFile="~/Admin/Admin.Master" %>
                ...
                <asp:TemplateField HeaderText="联系方式" HeaderStyle-CssClass="td_right td_left">
                 <itemstyle  CssClass="Name" />
                    <ItemTemplate >
                            ...
                            <div><asp:Literal ID="litContactWay" runat="server" Text='<%# Globals.HtmlDecode( Eval("ContactWay").ToString())%>'></asp:Literal></div>
                    </ItemTemplate>
                 </asp:TemplateField>
                
                
                 <asp:TemplateField HeaderText="咨询类型" HeaderStyle-CssClass="td_right td_left">
                 <itemstyle  CssClass="Name" />
                    <ItemTemplate >
                        
                            <div><asp:Literal ID="litFeedBackType" runat="server" Text='<%# Globals.HtmlDecode( ConverFeedBackType(Eval("FeedBackType")))%>'></asp:Literal></div>
                    </ItemTemplate>
                 </asp:TemplateField>    
