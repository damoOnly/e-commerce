<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.EditArticle" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="areacolumn clearfix">
      ...
      <div class="formitem validator2">
        <ul>
          <li> <span class="formitemtitle Pw_100"><em >*</em>所属分类：</span><abbr class="formselect">
          ...
          <li> <span class="formitemtitle Pw_100"><em >*</em>主题：</span>
            <asp:TextBox ID="txtArticleTitle" runat="server" CssClass="forminput"></asp:TextBox>
              　<input type="checkbox" id="ckrrelease" runat="server"/>是否立即发布&nbsp;
