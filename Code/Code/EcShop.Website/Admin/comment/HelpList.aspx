<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.HelpList" MasterPageFile="~/Admin/Admin.Master" %>
...
<div class="optiongroup mainwidth">
		<ul>
			<li class="menucurrent"><a href="HelpList.aspx"><span>帮助管理</span></a></li>
			<li class="optionend"><a href="HelpCategories.aspx"><span>帮助分类管理</span></a></li>
		</ul>
	</div>
	<!--选项卡-->
	...
	<div class="dataarea mainwidth">
		...
		<!--结束-->
	    <div class="Pa_15">
          <a href="AddHelp.aspx" class="submit_jia">添加新帮助</a>
	    </div>
			...
			<ul class="a_none_left">
				...
				<li>
					<abbr class="formselect">
						<Hi:HelpCategoryDropDownList ID="dropHelpCategory" NullToDisplay="全部" runat="server"/>
					</abbr>
				</li>
	  ...
	  <div class="datalist">
            ...
            <Columns>                 
                 ...
                 <asp:TemplateField HeaderText="主题" HeaderStyle-CssClass="td_right td_left" >
                       <ItemTemplate>
                           <a href='<%# "../../HelpDetails.aspx?HelpId=" + Eval("HelpId")%> ' target="_blank">
                            <asp:Literal id="lblHelpTitle" Text='<%#Eval("Title") %>' runat="server"></asp:Literal></a>
                        </ItemTemplate>
                 </asp:TemplateField>
                 ...
                 <asp:TemplateField HeaderText="操作" ItemStyle-Width="20%" HeaderStyle-CssClass="td_left td_right_fff" >
                     <ItemTemplate>
                         <span class="submit_bianji"><a href='<%# "Edithelp.aspx?HelpId=" + Eval("HelpId")%> '>编辑</a></span>
