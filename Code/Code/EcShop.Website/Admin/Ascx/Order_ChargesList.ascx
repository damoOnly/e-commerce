<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Order_ChargesList.ascx.cs" Inherits="EcShop.UI.Web.Admin.Order_ChargesList" %>
...
<div class="Settlement">
    <table width="200" border="0" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                <asp:Literal ID="litPayCharge" runat="server" />&nbsp;(<asp:Literal ID="litPayMode" runat="server"></asp:Literal>)</td>
        ...
        <tr>
            ...
            <td colspan="2"><span class="colorB">
                <asp:Literal ID="litCouponValue" runat="server" Visible="false" /><asp:Literal ID="litCoupon" runat="server" /></span></td>
        </tr>
        <tr>
            <td align="right">现金券折扣(元)：</td>
            <td colspan="2"><span class="colorB">
                <asp:Literal ID="litVoucherValue" runat="server" Visible="false" /><asp:Literal ID="litVoucher" runat="server" /></span></td>
        </tr>
<%--        <tr>
            <td align="right">活动优惠价(元)：</td>
            <td colspan="2"><span class="colorB">
                <asp:Literal ID="litActivityValue" runat="server" Visible="false" /><asp:Literal ID="litActivity" runat="server" /></span></td>
        </tr>--%>
        <tr>
        ...
        <tr class="bg">
            ...
            <td colspan="2"><strong class="colorG fonts">
                <asp:Literal ID="litTotalPrice" runat="server" /></strong></td>
        </tr>
    </table>
</div>
