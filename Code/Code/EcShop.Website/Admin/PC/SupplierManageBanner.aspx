<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SupplierManageBanner.aspx.cs" Inherits="EcShop.UI.Web.Admin.PC.SupplierManageBanner" %>
...
<div class="dataarea mainwidth databody">
  ...
  <span>如果您选择了首页带有轮播图的模板，您需要在此配置好相关参数。</span></div>  
		<!-- 添加按钮-->
   <div class="btn">
       <a class="submit_jia" href="javascript:DialogFrame('PC/SupplierAddBanner.aspx?Id=0','添加轮播',null,null)">添加轮播 </a>
 </div>
...
<%#((BannerInfo)Container.DataItem).LocationType == LocationType.Phone ? ((BannerInfo)Container.DataItem).Url : ((BannerInfo)Container.DataItem).LoctionUrl%>
                    ...
                    <UI:SortImageColumn HeaderText="排序" ItemStyle-Width="60px" ReadOnly="true" HeaderStyle-CssClass="td_right td_left"/>
                     <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_left td_right_fff">
                         <ItemTemplate>
                            <span class="submit_bianji"> <a  href="javascript:DialogFrame('<%# "PC/SupplierAddBanner.aspx?Id="+ ((BannerInfo)Container.DataItem).Id %>','编辑轮播图',null,null)">编辑</a> </span>
