...
function ShowAddDiv() {
    DialogFrameClose("promotion/AddSelectProduct.aspx", "添加商品", null, null);
}
...
function CollectInfos() {
    ...
    if (trs.length < 1 && $('#ctl00_contentHolder_rdoProduct').attr("checked") ==true) {
        alert("至少选择一件商品");
        flag = false;
    }
    else {
        trs.each(function (i, item) {
            ...
            inputstr += $(item).children().eq(1).html()+ ",";
        });
