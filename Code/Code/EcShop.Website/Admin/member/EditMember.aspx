<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditMember.aspx.cs" Inherits="EcShop.UI.Web.Admin.EditMember" %>
        ...
        <div class="columnright">
            ...
            <div class="formitem validator4 clearfix">
                <ul>
                    ...
                    <li><span class="formitemtitle Pw_110">微信号码：</span>
                        <asp:TextBox ID="txtMSN" runat="server" CssClass="forminput"></asp:TextBox>
                        <p id="ctl00_contentHolder_txtMSNTip">请输入正确微信号码，长度在1-256个字符以内</p>
                    </li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="Server">
    <script type="text/javascript" language="javascript">
        function InitValidators() {
            ...
            initValid(new InputValidator('ctl00_contentHolder_txtMSN', 1, 256, true, null, '请输入正确微信号码，长度在1-256个字符以内'));
