<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddMemberGrade.aspx.cs" Inherits="EcShop.UI.Web.Admin.AddMemberGrade" %>
      ...
      <div class="formitem validator4">
        <ul>
          ...
          <li> <span class="formitemtitle Pw_110"><em >*</em>会员等级价格：</span>
		    ...
		    <p id="ctl00_contentHolder_txtValueTip">等级折扣为不能为空，且是数字</p>
          </li>
