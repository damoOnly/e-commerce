<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OpenIdServices.aspx.cs" Inherits="EcShop.UI.Web.Admin.member.OpenIdServices" %>
...
<div class="dataarea mainwidth databody">
	  <div class="title">
	    <h1><table><tr><td>已开启</td></tr></table></h1>
    </div>
  <div class="datalist">
    ...
    <asp:Panel runat="server" ID="pnlConfigedNote">
	  ...
	  <div class="title">
	    <h1><table><tr><td>未开启</td></tr></table></h1>
    </div>
    <div class="datalist">
