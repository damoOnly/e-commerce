<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ManageMembers.aspx.cs" Inherits="EcShop.UI.Web.Admin.ManageMembers" %>
...
<div class="dataarea mainwidth databody">
  ...
  <h1>会员列表</h1>
  <span>对商城的会员进行管理，您可以修改会员的资料或调整会员的等级</span>
</div>
		<!--搜索-->
		...
		<div class="datalist">
			...
			<ul>
                ...
                <li>
                    <span>用户注册类型：</span>
					<abbr class="formselect">
						<Hi:UserTypeDropDownList ID="userTypeDropDownList" runat="server" AllowNull="true" NullToDisplay="全部" />
				    </abbr>
				</li>
			</ul> <li><span>注册时间：</span></li>
                <li>
                   <span><UI:WebCalendar CalendarType="StartDate" ID="calendarStartDate" runat="server" CssClass="forminput" /><abbr class="formselect"><Hi:HourDropDownList ID="Starthours" runat="server" style=" margin-left:5px;"/></abbr></span>
                        <span class="Pg_1010">至</span>
                        <UI:WebCalendar ID="calendarEndDate" runat="server" CalendarType="StartDate" CssClass="forminput" /><abbr class="formselect"><Hi:HourDropDownList ID="Endhours" runat="server" style=" margin-left:5px;"/></abbr>
                </li>
				<li>
		    ...
		    <UI:Grid ID="grdMemberList" runat="server" ShowHeader="true" AutoGenerateColumns="false" DataKeyNames="UserId" HeaderStyle-CssClass="table_title" GridLines="None" Width="100%">
                    <Columns>
                      ...
                      <asp:TemplateField HeaderText="手机号"  HeaderStyle-CssClass="td_right td_left" ShowHeader="true">
                        ...
                        <asp:TemplateField HeaderText="微信OpenId" SortExpression="GradeName" HeaderStyle-CssClass="td_right td_left">                            
                            <itemtemplate>
	                              <asp:Literal ID="lblOpenId" runat="server" Text='<%# Eval("OpenId") %>' />&nbsp;
                             </itemtemplate>
                        </asp:TemplateField>
