...
<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ClientSet.aspx.cs" Inherits="EcShop.UI.Web.Admin.ClientSet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="dataarea mainwidth databody">
        <div class="title m_none td_bottom">
            ...
            <span>按照客户的下单时间、下单频次、订单金额等字段进行分组管理多维度筛选条件,
          ...
          <div class="formitem_con">
             ...
             <div class="webcal">
                 ...
                 <div class="radionew2" style="margin-top:15px;">
                      <input id="radioactivymoney" name="radioactivy" type="radio" runat="server"/>　满足订单金额 
                      <samp class="formselect">  
