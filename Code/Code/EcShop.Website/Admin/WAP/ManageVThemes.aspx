<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ManageVThemes.aspx.cs" Inherits="EcShop.UI.Web.Admin.WAPShop.ManageVThemes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div class="title"> 
      ...
      <h1>您正在使用<span style="color:red; font-size:18px;margin:0px 10px;" id="spanThemeName"><asp:Literal ID="litThemeName" runat="server"></asp:Literal></span>模板</h1>
		<span>触屏版商城的页面风格，好比实体店面的装修，您可以从以下列表中选择您喜欢的风格</span>
    </div>
    <div class="blank12 clearfix"></div>
	<div class="datafrom">
      <div class="TemplateVshop">
...
<asp:Content ID="Content3" ContentPlaceHolderID="validateHolder" runat="server">
    <script type="text/javascript" >
        $(document).ready(function () {
            $.each($(".TemplateVshop li"), function () {
