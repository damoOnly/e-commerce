<%@ Page Language="C#" AutoEventWireup="true" Inherits="EcShop.UI.Web.Admin.WAPShop.VServerConfig" CodeBehind="VServerConfig.aspx.cs" MasterPageFile="~/Admin/Admin.Master" %>
	  ...
	  <div class="datafrom">
	    <div class="formitem validator1">
          ...
          <abbr class="formselect">
            ...
            <li class="clearfix"><span class="formitemtitle Pw_198">微信通用登录接口：</span>
