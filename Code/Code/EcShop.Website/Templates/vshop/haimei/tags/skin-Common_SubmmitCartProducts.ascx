...
<li>
    <div class="ct-box">
        <div class="ct-img">
            <a href="<%# Globals.ApplicationPath + "/Vshop/"+(!string.IsNullOrEmpty(this.Page.Request["countDownId"])?"CountDownProductsDetails":"ProductDetails")+".aspx?productId=" + Eval("ProductId")+"&CountDownId="+this.Page.Request["CountDownId"] %>">
