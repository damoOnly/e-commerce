	...
	var goodFieldView = fieldView.extend({
		...
		buildGoods:function(isReplace){
			...
			for(var i=0;i<data.models.length;i++){
                ...
                str += '<div class="good-img"> <img src="'+obj.img+'"/></div>';
		...
		buildBanners:function(isReplace){
			...
			if(type == 1){
				...
				for(var i=0;i<data.models.length;i++){
					...
					var classStyle = "";	
					if(size == 0){//大图						
						str += '<tr><td class="w100"><a class="mb10" href="'+href+'">'+title+'<img src="'+obj.img+'"/></a></td></tr>';
					}else if(size == 1){//小图
						if(i%2 == 0){//单数
							classStyle = "mr5";
							str += '<tr><td><a class="mb10 mr5" href="'+href+'">'+title+'<img src="'+obj.img+'"/></a></td>';
						}else{//双数
							str += '<td><a class="mb10 ml5" href="'+href+'">'+title+'<img src="'+obj.img+'"/></a></td></tr>';
						}						
					}
					else if(size == 2){//一大两小（横排）
						if(i%3 == 0){//第一个							
							str += '<tr><td rowspan="2"><a href="'+href+'" class="mr5">'+title+'<img src="'+obj.img+'"/></a></td>';
						}else if(i%3 == 1){//第二个
							str += '<td><a href="'+href+'" class="ml5">'+title+'<img src="'+obj.img+'"/></a></td></tr>';
						}else{//第三个
							str += '<tr><td class="vb"><a href="'+href+'" class="ml5">'+title+'<img src="'+obj.img+'"/></a></td></tr>';
						}
					}
					else if(size == 3){//一大四小（竖排）
						if(i%5 == 0){//第一个
							str += '<tr><td class="w100" colspan="4"><a href="'+href+'" class="mb10">'+title+'<img src="'+obj.img+'"/></a></td></tr><tr>';
						}else{
							str += '<td class="w25"><a href="'+href+'" class="mb10">'+title+'<img src="'+obj.img+'"/></a></td>';
						}
						if(i%5 == 4){
							str += '</tr>';
						}
	...
	var navFieldView = fieldView.extend({
		...
		buildBanners:function(isReplace){
			...
			for(var i=0;i<data.models.length;i++){
				...
				str += '<li> <a href="'+href+'"> <img src="'+obj.img+'"/><span>'+(obj.title?obj.title:"名称")+'</span> </a> </li>';
			}
			str += '</ul></div>';
			/**/
			str += this.getFooterHtml();			
