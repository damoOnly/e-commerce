...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_box1">
    <tr>
        <td align="center">
            <asp:Literal ID="litCouponName" runat="server" Text="现金券名称"></asp:Literal></td>
        <td align="center">
    ...
    <asp:Repeater ID="repeaterVoucher" runat="server" >
        <ItemTemplate>
            <tr class="ddgl_1">
                <td align="center">
                    <%# Eval("Name") %>
                ...
                <td align="center"><%# Eval("VoucherStatus").ToString() == "1" ? "已使用" :((DateTime)Eval("ClosingTime")<(DateTime)Eval("CurrentTime")?"已过期":"未使用") %></td>
            </tr>
        </ItemTemplate>
    </asp:Repeater>
</table>