...
<head>
<meta property="qc:admins" content="2715545660601151416563757" />
...
<Hi:Script ID="Script2" runat="server" Src="/utility/jquery-1.6.4.min.js" />
    ...
    <Hi:TemplateStyle ID="Stylee1" runat="server" Href="/style/style.css?t=20120310"></Hi:TemplateStyle>
    <Hi:TemplateStyle ID="Style1" runat="server" Href="/style/menu.css?v=20151219"></Hi:TemplateStyle>
...
<div class="online-wrap">
	<a href="javascript:void(0);" class="kf" onclick="window.open('http://chat16.live800.com/live800/chatClient/chatbox.jsp?companyID=101232&amp;jid=5779940222&amp;enterurl=file%3A%2F%2FD%3A%5CProgram+Files%5CTomcat+6%2E0%5Cwebapps%5CCococ%5Ccc%5Ca%5Fchat%2Ehtml&amp;tm=1282291489109 [^]','feiren','toolbar=no,location=no,top=10,left=10,width=600,height=400');" class="service"><b></b>在线客服</a>
</div>-->
        ...
        <div class="top_nav_bg">
            <div class="top_nav1">                
                <div class="top_link fix">                
                    ...
                    <%--<a href="DownloadApp.aspx" class="down-link">下载APP</a>   --%>                
                    <div class="link_list"> 
                        <div style="float:left;"><a href="/helpItem.aspx?helpid=73">招商合作&nbsp;&nbsp;</a></div><span>|&nbsp;&nbsp;</span>
                    	<div style="float:left;">
                        	<div class="dor-dt fix"><a title="手机海美生活" href="DownApp.aspx" target="_blank"><%--<i class="dor-icon"></i>--%><span class="dor-tit">手机海美生活</span></a></div>
                            <!--<div class="dor-con">
                            	<div class="qc-item last fix">
                                	<%--<div class="qc-img"><img src="/templates/master/haimei/images/qc.jpg" class="img-responsive"></div>--%>
                                    <div class="qc-info">
                                    	<%--<h5>手机海美生活</h5>--%>
                                        <div class="fix">
                                        <a title="下载苹果版APP" href="DownApp.aspx" target="_blank" class="ios">iphone</a>
                                        <a title="下载安卓版APP" href="DownApp.aspx" target="_blank" class="android">Android</a>
                                        </div>
                                    </div>
                                </div>
                                <!--<div class="qc-item last fix">
                                	<div class="qc-img"><img src="/templates/master/haidao/images/down/qc/ios.png" class="img-responsive"></div>
                                    <div class="qc-info">
                                    	<h5></h5>
                        ...
                        <span>|</span>
                        <div class="dorpdown qc-dorpdown">
                        	<div class="dor-dt fix"><i class="dor-icon"></i><div class="dor-tit">关注海美生活</div></div>
                            <div class="dor-con">
                            	<div class="qc-item last fix">
                                	<div class="qc-img" style="width:100%;float:none"><img src="/templates/master/haimei/images/qc.jpg" class="img-responsive"><p>关注海美微商城</p></div>                                   	
                        ...
                        <span>|</span> 
                         ...
                         <span>
                            <Hi:SiteUrl  UrlName="user_UserOrders" runat="server">我的订单</Hi:SiteUrl>
                        ...
                        <span>|</span> <span>
                            ...
                            <span>|</span>
                              <span><div id="shoucang"><Hi:Common_CustomAd runat="server" AdId="28" /></div></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="nav_bg nobor">
            <div class="nav1">
          		<div class="side_nav">
                    ...
                    <div class="my_left_category" id="left-menu">
				...
				// $(function(){
						$(".h2_cat").each(function(){
					        $(this).hover(function(){
								...
								//$(this).parent().addClass('my_left_cat_list_active');
					        });
					    });
					//购物车 数量为0时 不显示
...
//左侧导航start
$(function(){
	$('#left-menu>div').filter('#left-menu>div:gt(3)').hide();
	$('#left-menu>div').eq(3).css('border-bottom','none');
	/*function setHeight(){
...
$(function(){
	//点击 头部 海捣APP 显示 下拉的 二维码
	$(".dorpdown .dor-dt").bind("click",function(){
		var $p = $(this).parent();		
		var theme = "selected";
		$p.siblings(".dorpdown").removeClass(theme);
		if($p.hasClass(theme)){
			$p.removeClass(theme);
		}else{
			$p.addClass(theme);
	...
	//鼠标移动 、移出 头部 海捣APP 显示/隐藏 下拉的 二维码
...
//左侧导航over
    ...
    <script src="../../../../../Utility/switchsite.js" type="text/javascript"></script>
    </div>
