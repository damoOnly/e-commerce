...
<li>
    ...
    <div class="related_name">
        <Hi:ProductDetailsLink ID="ProductDetailsLink1" runat="server" ProductName='<%# Eval("ProductName") %>' ProductId='<%# Eval("ProductId") %>'></Hi:ProductDetailsLink></div>
    <div class="related_price"><strong>
        <Hi:FormatedMoneyLabel ID="lblSalePrice" runat="server" Money='<%# Eval("SalePrice") %>' /></strong></div>
</li>
