...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab_box1">
	...
	<tr class="ddgl_1">
        ...
        <td align="center"><asp:HyperLink ID="hlinkOrderDetails" runat="server" Target="_blank" NavigateUrl='<%# Globals.GetSiteUrls().UrlData.FormatUrl("user_UserReturnsApplyDetails",Eval("ReturnsId"))%>'
            Text="查看" /></td>
	</tr>
    </ItemTemplate>
    </asp:repeater>
