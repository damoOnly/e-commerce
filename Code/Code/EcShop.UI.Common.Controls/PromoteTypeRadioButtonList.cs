		...
		protected override void Render(HtmlTextWriter writer)
		{
			...
			if (this.IsProductPromote)
			{
				...
				else
				{
                    ...
                    stringBuilder.AppendFormat("<input id=\"radPromoteType_FullCut\" type=\"radio\" name=\"radPromoteType\" value=\"{0}\" />单品满减", 7);
                    stringBuilder.AppendFormat("<input id=\"radPromoteType_DoubleReduced\" type=\"radio\" name=\"radPromoteType\" value=\"{0}\" />第二件减价", 8);
                    stringBuilder.AppendFormat("<input id=\"radPromoteType_DoubleDiscount\" type=\"radio\" name=\"radPromoteType\" value=\"{0}\" />第二件打折", 9);
                    // 有买有送，可以赠送随意的商品
                    stringBuilder.AppendFormat("<input id=\"radPromoteType_PresentProduct\" type=\"radio\" name=\"radPromoteType\" value=\"{0}\" />有买有送(选择商品)", 10);
					if (this.IsSubSite)
					{
						stringBuilder.AppendFormat("<input id=\"radPromoteType_QuantityDiscount\" type=\"radio\" name=\"radPromoteType\" value=\"{0}\" />批发打折", 4);
					}
