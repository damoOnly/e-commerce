...
namespace EcShop.UI.Common.Controls
{
	...
	public abstract class HtmlTemplatedWebControl : TemplatedWebControl
	{
		...
		private string ControlText()
		{
			...
			stringBuilder.Insert(0, "<%@ Register TagPrefix=\"Hi\" Namespace=\"EcShop.UI.AccountCenter.CodeBehind\" Assembly=\"EcShop.UI.AccountCenter.CodeBehind\" %>" + Environment.NewLine);
