...
{
    public class CountDownLeaveListTime : Control
	{
        ...
        private string rownumber = "CurrNumber";
		...
		public override void DataBind()
		{
            ...
            int num2 = Convert.ToInt32(DataBinder.Eval(this.Page.GetDataItem(), this.RowNumber).ToString());
