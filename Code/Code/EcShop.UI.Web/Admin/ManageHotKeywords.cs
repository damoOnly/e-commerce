...
namespace EcShop.UI.Web.Admin
{
	...
	public class ManageHotKeywords : AdminPage
	{
		...
		private void btnSubmitHotkeyword_Click(object sender, System.EventArgs e)
		{
			...
			for (int i = 0; i < array2.Length; i++)
			{
                ...
                if (this.dropCategory.SelectedValue.HasValue)
                {
                    ...
                    {
                        StoreHelper.AddHotkeywords(this.dropCategory.SelectedValue.Value, text2, ClientType.PC, HiContext.Current.User.UserId);
                        num++;
                    }
                }
                else
                {
                    ...
                    {
                        StoreHelper.AddHotkeywords(null, text2, ClientType.PC, HiContext.Current.User.UserId);
                        num++;
                    }
                }
			}
		...
		{
            System.Data.DataTable hotKeywords = StoreHelper.GetHotKeywords(ClientType.PC);
