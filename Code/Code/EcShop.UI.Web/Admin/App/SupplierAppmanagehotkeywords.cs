...
{
    [PrivilegeCheck(Privilege.SupplierAppmanagehotkeywords)]
    public class SupplierAppmanagehotkeywords : AdminPage
    {
        ...
        private void btnEditHotkeyword_Click(object sender, System.EventArgs e)
        {
            ...
            if (this.dropEditCategory.SelectedValue.HasValue)
            {
                ...
                StoreHelper.UpdateHotWords(hid, this.dropEditCategory.SelectedValue.Value, this.txtEditHotKeyword.Text.Trim(), supplierId);
            ...
            else
            {
                ...
                StoreHelper.UpdateHotWords(hid, null, this.txtEditHotKeyword.Text.Trim(), supplierId);
                this.ShowMsg("编辑热门关键字成功！", true);
                this.hicategory.Value = "";
                this.hiHotKeyword.Value = "";
                this.BindData();
        ...
        private void btnSubmitHotkeyword_Click(object sender, System.EventArgs e)
        {
            ...
            for (int i = 0; i < array2.Length; i++)
            {
                ...
                if (this.dropCategory.SelectedValue.HasValue)
                {
                    ...
                    {
                        StoreHelper.AddHotkeywords(this.dropCategory.SelectedValue.Value, text2, ClientType.App, supplierId);
                        num++;
                    }
                }
                else
                {
                    ...
                    {
                        StoreHelper.AddHotkeywords(null, text2, ClientType.App, supplierId);
                        num++;
                    }
                }
            }
        ...
        {
            this.grdHotKeywords.DataSource = StoreHelper.GetHotKeywords(ClientType.App, 0, 0, supplierId);
            this.grdHotKeywords.DataBind();
        }
        private bool IsSame(string word, int? categoryId)
        {
            System.Data.DataTable hotKeywords = StoreHelper.GetHotKeywords(ClientType.App, 0, 0, supplierId);
