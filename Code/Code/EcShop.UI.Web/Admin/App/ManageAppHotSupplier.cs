...
{
    [PrivilegeCheck(Privilege.ManageAppHotSupplier)]
    public class ManageAppHotSupplier : AdminPage
    {
        ...
        {
            this.grdSupplier.DataSource = SupplierConfigHelper.GetSupplierCfgByType(ClientType.App, SupplierCfgType.Hot);
