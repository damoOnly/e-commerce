...
namespace EcShop.UI.Web.Admin
{
	...
	public class OrderGifts : AdminPage
	{
		...
		private void dlstGifts_ItemCommand(object source, System.Web.UI.WebControls.DataListCommandEventArgs e)
		{
		...
		private void dlstOrderGifts_DeleteCommand(object source, System.Web.UI.WebControls.DataListCommandEventArgs e)
		{
			if (!this.order.CheckAction(OrderActions.MASTER_SELLER_MODIFY_GIFTS))
			{
				this.ShowMsg("当前订单状态没有订单礼品操作", false);
