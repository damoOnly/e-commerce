...
{
    public class SupplierAddHotProduct : AdminPage
    {
        private int id;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            {
                base.Response.Redirect("SupplierAddHotProduct.aspx");
            }
        }
        protected void btnAddBanner_Click(object sender, System.EventArgs e)
        {
            if (this.id == 0)
            {
                TplCfgInfo tplCfgInfo = new HotSaleInfo();
            ...
            else
            {
                ...
                tplCfgById.Client = (int)ClientType.PC; ;
