...
{
    [PrivilegeCheck(Privilege.ManageAppCheapProduct)]
	public class ManageAppCheapProduct : AdminPage
	{
		...
		{
            this.grdPromotional.DataSource = VShopHelper.GetAllPromotional(ClientType.App);
