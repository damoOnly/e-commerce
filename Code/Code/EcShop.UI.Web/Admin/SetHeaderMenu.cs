...
namespace EcShop.UI.Web.Admin
{
	...
	public class SetHeaderMenu : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.grdHeaderMenu.RowDataBound += new System.Web.UI.WebControls.GridViewRowEventHandler(this.grdHeaderMenu_RowDataBound);
			this.grdHeaderMenu.RowCommand += new System.Web.UI.WebControls.GridViewCommandEventHandler(this.grdHeaderMenu_RowCommand);
			this.grdHeaderMenu.RowDeleting += new System.Web.UI.WebControls.GridViewDeleteEventHandler(this.grdHeaderMenu_RowDeleting);
		...
		private void grdHeaderMenu_RowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
		{
			if (e.Row.RowType == System.Web.UI.WebControls.DataControlRowType.DataRow)
			{
				...
				hyperLink.NavigateUrl = Globals.GetAdminAbsolutePath(string.Format("/store/EditHeaderMenu.aspx?Id={0}&ThemName={1}", num, this.themName));
		...
		{
			foreach (System.Web.UI.WebControls.GridViewRow gridViewRow in this.grdHeaderMenu.Rows)
			{
				int id = (int)this.grdHeaderMenu.DataKeys[gridViewRow.RowIndex].Value;
		...
		private void BindHeaderMenu()
		{
			...
			this.grdHeaderMenu.DataSource = dataTable;
