...
{
    [PrivilegeCheck(Privilege.SearchPromotionPresentPro)]
    public class SearchPromotionPresentPro : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            int.TryParse(this.Page.Request.QueryString["presentsNum"], out this.presentNum);
			if (!base.IsPostBack)
			{
				this.DoCallback();
			}
		...
		protected void DoCallback()
		{
            ...
            //促销活动Id
            productQuery.PresentActivityId = this.activityId;
