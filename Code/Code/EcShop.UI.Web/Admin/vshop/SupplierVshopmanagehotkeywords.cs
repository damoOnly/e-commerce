...
{
    [PrivilegeCheck(Privilege.SupplierVshopmanagehotkeywords)]
    public class SupplierVshopmanagehotkeywords : AdminPage
    {
        ...
        {
            this.grdHotKeywords.DataSource = StoreHelper.GetHotKeywords(ClientType.VShop, 0, 0, supplierId);
            this.grdHotKeywords.DataBind();
        }
        private bool IsSame(string word, int? categoryId)
        {
            System.Data.DataTable hotKeywords = StoreHelper.GetHotKeywords(ClientType.VShop, 0, 0, supplierId);
