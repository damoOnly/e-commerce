...
{
	[PrivilegeCheck(Privilege.vShengPaySet)]
	public class ShengPaySet : AdminPage
	{
		protected YesNoRadioButtonList radEnableVshopShengPay;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!base.IsPostBack)
			{
				...
				this.radEnableVshopShengPay.SelectedValue = masterSettings.EnableVshopShengPay;
		...
		{
			SiteSettings masterSettings = SettingsManager.GetMasterSettings(false);
			masterSettings.EnableVshopShengPay = this.radEnableVshopShengPay.SelectedValue;
