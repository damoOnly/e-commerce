...
namespace EcShop.UI.Web.Admin.vshop
{
    ...
    public class SupplierSearchHomeProduct : AdminPage
    {
        ...
        protected void btnAdd_Click(object sender, System.EventArgs e)
        {
            ...
            for (int i = 0; i < array2.Length; i++)
            {
                ...
                if (VShopHelper.AddHomeProdcut(System.Convert.ToInt32(value), ClientType.VShop, supplierId))
                {
                    num++;
                }
            }
