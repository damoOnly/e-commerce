...
{
    [PrivilegeCheck(Privilege.SupplierManageNewProduct)]
    public class SupplierManageNewProduct : AdminPage
    {
        ...
        private void BindData()
        {
            ...
            this.grdRecommend.DataSource = VShopHelper.GetAllRecommend(ClientType.VShop, supplierId);
