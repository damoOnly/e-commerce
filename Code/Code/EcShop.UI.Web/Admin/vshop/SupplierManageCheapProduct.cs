...
{
    [PrivilegeCheck(Privilege.SupplierManageCheapProduct)]
    public class SupplierManageCheapProduct : AdminPage
    {
        ...
        private void BindData()
        {
            ...
            this.grdPromotional.DataSource = VShopHelper.GetAllPromotional(ClientType.VShop, supplierId);
