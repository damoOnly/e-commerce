...
{
    [PrivilegeCheck(Privilege.SupplierHomeProductSetting)]
    public class SupplierHomeProductSetting : AdminPage
    {
        ...
        { //根据登录用户获取供应商id
            ...
            this.grdHomeProducts.DataSource = VShopHelper.GetHomeProducts(ClientType.VShop, true, supplierId);
