...
namespace EcShop.UI.Web.Admin
{
    ...
    public class EditProduct : ProductBasePage
    {
        ...
        protected System.Web.UI.HtmlControls.HtmlGenericControl li_Purchase;
        ...
        // 组合商品
        protected System.Web.UI.WebControls.Repeater rpCombination;
        ...
        private void BindCombinationData()
        {
            this.rpCombination.DataSource = ProductHelper.GetCombinationDataByProductId(this.productId);
            this.rpCombination.DataBind();
        }
