		...
		private void UploadImage()
		{
			try
			{
				...
				if (string.IsNullOrEmpty(text))
				{
					...
					string text2 = System.Web.HttpContext.Current.Request["clientType"];
					...
					{
						text = HiContext.Current.GetVshopSkinPath(null) + "/images/ad/";
					}
					else
					{
						if (clientType == ClientType.WAP)
						{
							text = HiContext.Current.GetWapshopSkinPath(null) + "/images/ad/";
						}
						else
						{
							if (clientType == ClientType.AliOH)
							{
								text = HiContext.Current.GetAliOHshopSkinPath(null) + "/images/ad/";
							}
						}
					}
			...
			{
				System.Web.HttpContext.Current.Response.Write("服务器错误" + ex.Message);
