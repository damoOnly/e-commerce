...
{
    [PrivilegeCheck(Privilege.SupplierManageAppCheapProduct)]
    public class SupplierManageAppCheapProduct : AdminPage
    {
        ...
        private void BindData()
        {
            ...
            this.grdPromotional.DataSource = VShopHelper.GetAllPromotional(ClientType.App, supplierId);
