...
{
    [PrivilegeCheck(Privilege.SupplierManageAppNavigate)]
    public class SupplierManageAppNavigate : AdminPage
    {
        ...
        private void BindData()
        {
            ...
            this.grdNavigate.DataSource = VShopHelper.GetAllNavigate(ClientType.App, supplierId);
