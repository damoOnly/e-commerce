...
{
	[PrivilegeCheck(Privilege.vMobileAlipaySet)]
	public class VshopAliPaySet : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!base.IsPostBack)
			{
				...
				this.radEnableWapAliPay.SelectedValue = masterSettings.EnableWeixinWapAliPay;
		...
		{
			SiteSettings masterSettings = SettingsManager.GetMasterSettings(false);
			masterSettings.EnableWeixinWapAliPay = this.radEnableWapAliPay.SelectedValue;
