...
{
    [PrivilegeCheck(Privilege.StoreOrderView)]
    public class StoreManageOrder : AdminPage
    {
        ...
        protected System.Web.UI.WebControls.DropDownList dllStoremanage;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            if (flag)
            {
                ...
                stringBuilder.AppendFormat(",\"Contacts\":\"{0}\"", !string.IsNullOrEmpty(orderInfo.RealName) ? orderInfo.RealName.Replace("\r\n", "") : "");
                stringBuilder.AppendFormat(",\"Email\":\"{0}\"", !string.IsNullOrEmpty(orderInfo.EmailAddress) ? orderInfo.EmailAddress.Replace("\r\n", "") : "");
                stringBuilder.AppendFormat(",\"Telephone\":\"{0}\"", !string.IsNullOrEmpty(orderInfo.TelPhone) ? orderInfo.TelPhone.Replace("\r\n", "") : "");
                stringBuilder.AppendFormat(",\"Address\":\"{0}\"", !string.IsNullOrEmpty(orderInfo.Address) ? orderInfo.Address.Replace("\r\n", "") : "");
                stringBuilder.AppendFormat(",\"Remark\":\"{0}\"", !string.IsNullOrEmpty(text) ? text.Replace("\r\n", "") : "");
                stringBuilder.AppendFormat(",\"PostCode\":\"{0}\"", !string.IsNullOrEmpty(orderInfo.ZipCode) ? orderInfo.ZipCode.Replace("\r\n", "") : "");
                base.Response.Clear();
            ...
            {
                userStoreId = ManagerHelper.GetStoreIdByUserId(HiContext.Current.User.UserId);
                this.BindStoremanage();
        ...
        /// 绑定门店信息
        /// </summary>
        private void BindStoremanage()
        {
            this.dllStoremanage.Items.Clear();
            this.dllStoremanage.Items.Add(new System.Web.UI.WebControls.ListItem("全部", string.Empty));
            DataTable dt = StoreManagementHelper.GetUserStore(userStoreId);
            if (dt != null && dt.Rows.Count > 0)
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ListItem item = new ListItem(dr["StoreName"].ToString(), dr["StoreId"].ToString());
                    this.dllStoremanage.Items.Add(item);
                    if (userStoreId > 0)
                    {
                        item.Selected = true;
                    }
            ...
            if (userStoreId > 0)
            {
                this.dllStoremanage.Enabled = false;
            }
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderReplaceRefuse);
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderReplaceAccept);
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderReturnRefuse);
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderReturnAccept);
            decimal num;
        ...
        protected void btnAcceptRefund_Click(object sender, System.EventArgs e)
        {
            ...
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderRefundAccept);
            string username = HiContext.Current.User.Username;
            OrderInfo orderInfo = OrderHelper.GetOrderInfo(this.hidOrderId.Value);
            if (OrderHelper.CheckRefund(orderInfo, username, this.hidAdminRemark.Value, int.Parse(this.hidRefundType.Value), 0, true, isReturn))
            {
                this.BindOrders();
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderRefundRefuse);
            string username = HiContext.Current.User.Username;
            OrderInfo orderInfo = OrderHelper.GetOrderInfo(this.hidOrderId.Value);
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderDownGoodsPick);
            string text = "";
            ...
            base.Response.AppendHeader("Content-Disposition", "attachment;filename= 门店商品配货单.xls");
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderDownTimeExcel);
            ...
            string startPayTime = this.calendarStartDate.SelectedDate.Value.ToShortDateString();
            string endPayTime = DateTime.Parse(this.calendarEndDate.SelectedDate.Value.ToShortDateString()).AddDays(1).AddMilliseconds(-1).ToString();
            System.Data.DataSet orderGoods = OrderHelper.GetOrderGoods(startPayTime, endPayTime, "", orderStatus, orderTimeType);
            System.Text.StringBuilder stringBuilder = new System.Text.StringBuilder();
            stringBuilder.AppendLine("<html><head><meta http-equiv=Content-Type content=\"text/html; charset=gb2312\"></head><body>");
            stringBuilder.AppendLine("<table cellspacing=\"0\" cellpadding=\"5\" rules=\"all\" border=\"1\">");
            stringBuilder.AppendLine("<caption style='text-align:center;'>配货单(仓库拣货表)</caption>");
            ...
            base.Response.AppendHeader("Content-Disposition", "attachment;filename=门店订单配货单_" + this.calendarStartDate.SelectedDate.Value.ToString("yyyyMMdd") + "-" + this.calendarEndDate.SelectedDate.Value.ToString("yyyyMMdd") + ".xls");
            base.Response.ContentEncoding = System.Text.Encoding.GetEncoding("GB2312");
            base.Response.ContentType = "application/ms-excel";
            this.EnableViewState = false;
            base.Response.Write(stringBuilder.ToString());
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderDownSelExcel);
            string text = "";
            if (!string.IsNullOrEmpty(base.Request["CheckBoxGroup"]))
            {
                text = base.Request["CheckBoxGroup"];
            ...
            base.Response.Charset = "GB2312";
            //base.Response.AppendHeader("Content-Disposition", "attachment;filename=ordergoods_" + System.DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls");
            base.Response.AppendHeader("Content-Disposition", "attachment;filename=门店订单配货单.xls");
            base.Response.ContentEncoding = System.Text.Encoding.GetEncoding("GB2312");
            base.Response.ContentType = "application/ms-excel";
            this.EnableViewState = false;
            base.Response.Write(stringBuilder.ToString());
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderDelete);
            string text = "";
            if (!string.IsNullOrEmpty(base.Request["CheckBoxGroup"]))
            {
                text = base.Request["CheckBoxGroup"];
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderSend);
            string text = "";
            if (!string.IsNullOrEmpty(base.Request["CheckBoxGroup"]))
            {
                text = base.Request["CheckBoxGroup"];
        ...
        private void BindOrders()
        {
            ...
            if (orderQuery.StoreId.HasValue)
            {
                this.dllStoremanage.SelectedValue = orderQuery.StoreId.ToString();
            }
        ...
        private void ReloadOrders(bool isSearch)
        {
            ...
            nameValueCollection.Add("StoreId", this.dllStoremanage.SelectedValue);
        ...
        {
            string format = Globals.ApplicationPath + "/Admin/sales/StoreManageOrder.aspx?orderStatus={0}";
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderClose);
            OrderInfo orderInfo = OrderHelper.GetOrderInfo(this.hidOrderId.Value);
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderClearTimeExcel);
            if (!(this.calendarStartDate.SelectedDate.HasValue && this.calendarEndDate.SelectedDate.HasValue))
            {
            ...
            int.TryParse(Request.QueryString["orderTimeType"], out orderTimeType);
            string endPayTime = DateTime.Parse(this.calendarEndDate.SelectedDate.Value.ToShortDateString()).AddDays(1).AddMilliseconds(-1).ToString();
            System.Data.DataSet orderGoods = OrderHelper.GetClearOrderGoods(startPayTime, endPayTime, "", orderStatus, orderTimeType);
            System.Text.StringBuilder stringBuilder = new System.Text.StringBuilder();
            stringBuilder.AppendLine("<html><head><meta http-equiv=Content-Type content=\"text/html; charset=gb2312\"></head><body>");
            stringBuilder.AppendLine("<table cellspacing=\"0\" cellpadding=\"5\" rules=\"all\" border=\"1\">");
            ...
            base.Response.Charset = "GB2312";
            //base.Response.AppendHeader("Content-Disposition", "attachment;filename=ordergoods_" + System.DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls");
            base.Response.AppendHeader("Content-Disposition", "attachment;filename=门店清关订单_" + this.calendarStartDate.SelectedDate.Value.ToString("yyyyMMdd") + "-" + this.calendarEndDate.SelectedDate.Value.ToString("yyyyMMdd") + ".xls");
            base.Response.ContentEncoding = System.Text.Encoding.GetEncoding("GB2312");
            base.Response.ContentType = "application/ms-excel";
            this.EnableViewState = false;
            base.Response.Write(stringBuilder.ToString());
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderClearSelExcel);
            string text = "";
            if (!string.IsNullOrEmpty(base.Request["CheckBoxGroup"]))
            {
                text = base.Request["CheckBoxGroup"];
            ...
            base.Response.Charset = "GB2312";
            //base.Response.AppendHeader("Content-Disposition", "attachment;filename=ordergoods_" + System.DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls");
            base.Response.AppendHeader("Content-Disposition", "attachment;filename=门店清关订单.xls");
            base.Response.ContentEncoding = System.Text.Encoding.GetEncoding("GB2312");
            base.Response.ContentType = "application/ms-excel";
            this.EnableViewState = false;
            base.Response.Write(stringBuilder.ToString());
        ...
        {
            ManagerHelper.CheckPrivilege(Privilege.StoreOrderClearGoodsPick);
            string text = "";
            if (!string.IsNullOrEmpty(base.Request["CheckBoxGroup"]))
            {
                text = base.Request["CheckBoxGroup"];
