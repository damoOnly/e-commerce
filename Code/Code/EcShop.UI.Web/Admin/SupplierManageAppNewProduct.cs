...
{
    [PrivilegeCheck(Privilege.SupplierManageAppNewProduct)]
    public class SupplierManageAppNewProduct : AdminPage
    {
        ...
        private void BindData()
        {
            ...
            this.grdRecommend.DataSource = VShopHelper.GetAllRecommend(ClientType.App, supplierId);
