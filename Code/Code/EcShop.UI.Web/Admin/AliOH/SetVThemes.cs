...
{
	[AdministerCheck(true), PrivilegeCheck(Privilege.AliohThemesSet)]
	public class SetVThemes : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				this.vTheme = SettingsManager.GetMasterSettings(true).AliOHTheme;
			}
			this.path = System.Web.HttpContext.Current.Request.MapPath(Globals.ApplicationPath + "/Templates/AliOHshop/" + this.vTheme + "/template.xml");
			...
			if (!this.Page.IsPostBack)
			{
				...
				this.imgPic.ImageUrl = HiContext.Current.GetAliOHshopSkinPath(this.vTheme) + "/images/ad/imgDefaultBg.jpg";
		...
		protected void btnOK_Click(object sender, System.EventArgs e)
		{
			...
			{
				xmlNode.SelectSingleNode("root/DefaultBg").InnerText = HiContext.Current.GetAliOHshopSkinPath(this.vTheme) + "/images/ad/imgDefaultBg.jpg";
			}
			else
			{
