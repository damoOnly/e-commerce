...
{
	[PrivilegeCheck(Privilege.AliohEditMenu)]
	public class EditMenu : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!this.Page.IsPostBack)
			{
				...
				{
					System.Collections.Generic.IList<MenuInfo> menusByParentId = VShopHelper.GetMenusByParentId(urlIntParam, ClientType.AliOH);
