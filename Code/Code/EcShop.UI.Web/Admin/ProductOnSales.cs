    ...
    public class ProductOnSales : AdminPage
    {
        ...
        private void btnExcelSupplierProDetatil_Click(object sender, System.EventArgs e)
        {
            ProductQuery productQuery = new ProductQuery
            {
                ...
                BarCode=!string.IsNullOrEmpty(this.txt_BarCode.Text)?this.txt_BarCode.Text.Trim():"",
                ...
                IsApprovedPrice = (!string.IsNullOrEmpty(this.dropIsApprovedPrice.SelectedValue) && this.dropIsApprovedPrice.SelectedValue != "-1") ? int.Parse(this.dropIsApprovedPrice.SelectedValue) : -1,
                IsAllClassify = (!string.IsNullOrEmpty(this.dropIsAllClassify.SelectedValue) && this.dropIsAllClassify.SelectedValue != "-1") ? int.Parse(this.dropIsAllClassify.SelectedValue) : -1
            };
            ...
            {
                stringBuilder.AppendLine("<tr>");
                stringBuilder.AppendLine("<td style=\"vnd.ms-excel.numberformat:@\">" + dataRow["productId"] + "_0</td>");
