...
{
    [PrivilegeCheck(Privilege.SupplierOrderPromotions)]
    public class SupplierOrderPromotions : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (this.isWholesale)
			{
                ...
                this.hlinkAddPromotion.NavigateUrl = "SupplierAddOrderPromotion.aspx?isWholesale=true";
			}
		...
		{
            this.grdPromoteSales.DataSource = PromoteHelper.GetPromotions(false, this.isWholesale, UserHelper.GetAssociatedSupplierId(HiContext.Current.User.UserId));
