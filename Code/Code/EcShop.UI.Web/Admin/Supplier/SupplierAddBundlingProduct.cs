...
{
	[PrivilegeCheck(Privilege.SupplierBundlingProducts)]
    public class SupplierAddBundlingProduct : AdminPage
	{
		...
		protected void btnAddBindProduct_Click(object sender, System.EventArgs e)
		{
            ...
            bundlingInfo.SupplierId = UserHelper.GetAssociatedSupplierId(HiContext.Current.User.UserId);
