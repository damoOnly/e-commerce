...
namespace EcShop.UI.Web.Admin
{
    ...
    public class SupplierAddOrderPromotion : AdminPage
	{
		...
		private void btnAdd_Click(object sender, System.EventArgs e)
		{
			...
			if (this.isWholesale)
			{
                base.Response.Redirect(Globals.GetAdminAbsolutePath("/supplier/SupplierOrderPromotions.aspx?isWholesale=true"), true);
				return;
			}
            base.Response.Redirect(Globals.GetAdminAbsolutePath("/supplier/SupplierOrderPromotions.aspx"), true);
		}
	}
}
