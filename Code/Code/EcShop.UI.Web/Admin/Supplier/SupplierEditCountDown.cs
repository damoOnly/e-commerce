...
namespace EcShop.UI.Web.Admin
{
    ...
    public class SupplierEditCountDown : AdminPage
	{
		...
		private void LoadCountDown(CountDownInfo countDownInfo)
		{
            ...
            this.txtPlanCount.Text = System.Convert.ToString(countDownInfo.PlanCount);
		...
		private void btnUpdateGroupBuy_Click(object sender, System.EventArgs e)
		{
            ...
            if (timeValidated && PromoteHelper.ProductCountDownExist(this.dropGroupBuyProduct.SelectedValue.Value, countDownInfo.StartDate, countDownInfo.EndDate, this.countDownId))
            {
