...
{
	[PrivilegeCheck(Privilege.SupplierGroupBuys)]
    public class SupplierAddGroupBuy : AdminPage
	{
		...
		private void btnAddGroupBuy_Click(object sender, System.EventArgs e)
		{
            ...
            groupBuyInfo.SupplierId = UserHelper.GetAssociatedSupplierId(HiContext.Current.User.UserId);
		...
		private string GenerateBrandString(System.Data.DataTable tb)
		{
			...
			{
				stringBuilder.Append("{");
				stringBuilder.AppendFormat("\"ProductId\":\"{0}\",\"ProductName\":\"{1}\"", dataRow["ProductId"], System.Uri.EscapeDataString(dataRow["ProductName"].ToString()));
				stringBuilder.Append("},");
			}
