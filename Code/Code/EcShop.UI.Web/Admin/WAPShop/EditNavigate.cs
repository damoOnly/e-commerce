...
{
	[PrivilegeCheck(Privilege.WapIconSet)]
	public class EditNavigate : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if (int.TryParse(base.Request.QueryString["Id"], out this.id))
			{
				...
				{
                    this.ddlType.BindEnum<EcShop.Entities.Wap.LocationType>("");//修改1
					this.BindIcons();
					this.Restore();
					return;
				}
		...
		protected void Restore()
		{
			...
			{
				this.ddlSubType.Attributes.CssStyle.Remove("display");
                this.ddlSubType.BindEnum<EcShop.Entities.Wap.LocationType>("");//修改1
