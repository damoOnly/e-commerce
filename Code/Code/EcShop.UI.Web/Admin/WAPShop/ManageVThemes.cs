...
namespace EcShop.UI.Web.Admin.WAPShop
{
	...
	public class ManageVThemes : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.litThemeName.Text = masterSettings.WapTheme;
		...
		{
			System.Collections.Generic.IList<ManageThemeInfo> list = this.LoadThemes(siteSettings.WapTheme);
		...
		protected System.Collections.Generic.IList<ManageThemeInfo> LoadThemes(string currentThemeName)
		{
			...
			string path = System.Web.HttpContext.Current.Request.PhysicalApplicationPath + HiConfiguration.GetConfig().FilesPath + "\\Templates\\Wapshop";
