...
{
	[PrivilegeCheck(Privilege.WapManageThemes)]
	public class SetVThemes : AdminPage
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			{
				this.vTheme = SettingsManager.GetMasterSettings(true).WapTheme;
			}
			this.path = System.Web.HttpContext.Current.Request.MapPath(Globals.ApplicationPath + "/Templates/wapshop/" + this.vTheme + "/template.xml");
			...
			if (!this.Page.IsPostBack)
			{
				...
				this.imgPic.ImageUrl = HiContext.Current.GetWapshopSkinPath(this.vTheme) + "/images/ad/imgDefaultBg.jpg";
		...
		protected void btnOK_Click(object sender, System.EventArgs e)
		{
			...
			{
				xmlNode.SelectSingleNode("root/DefaultBg").InnerText = HiContext.Current.GetWapshopSkinPath(this.vTheme) + "/images/ad/imgDefaultBg.jpg";
			}
			else
			{
			...
			HiCache.Remove("WapTemplateFileCache");
