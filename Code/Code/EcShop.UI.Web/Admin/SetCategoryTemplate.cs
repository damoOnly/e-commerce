...
namespace EcShop.UI.Web.Admin
{
	...
	public class SetCategoryTemplate : AdminPage
	{
		...
		private void btnUpload_Click(object sender, System.EventArgs e)
		{
			...
			string virtualPath = HiContext.Current.GetSkinPath() + "/categorythemes/" + SetCategoryTemplate.GetFilename(System.IO.Path.GetFileName(this.fileThame.PostedFile.FileName), System.IO.Path.GetExtension(this.fileThame.PostedFile.FileName));
		...
		private void btnDelete_Click(object sender, System.EventArgs e)
		{
			...
			string text = HiContext.Current.GetSkinPath() + "/categorythemes/" + this.dropThmes.SelectedValue;
