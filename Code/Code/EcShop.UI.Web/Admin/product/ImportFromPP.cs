...
namespace EcShop.UI.Web.Admin.product
{
	...
	public class ImportFromPP : AdminPage
	{
		...
		protected override void OnInitComplete(System.EventArgs e)
		{
			...
			this._dataPath = this.Page.Request.MapPath("~/storage/data/paipai");
		...
		private void btnImport_Click(object sender, System.EventArgs e)
		{
			...
			ProductHelper.ImportProducts((System.Data.DataTable)array[0], value, selectedValue, saleStatus, false);
