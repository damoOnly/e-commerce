...
namespace EcShop.UI.Web.Admin.product
{
	...
	public class ExportToPP : AdminPage
	{
		...
		private void btnExport_Click(object sender, System.EventArgs e)
		{
            ...
            {
                strstartDate = DateTime.Parse(this._startDate.ToString()).ToString("yyyyMMdd");
                strendDate = DateTime.Parse(this._endDate.ToString()).ToString("yyyyMMdd");
		...
		private void BindExporter()
		{
			...
			{
				this.dropExportVersions.Items.Add(new System.Web.UI.WebControls.ListItem(exportAdapters[current].Replace("4.0", "2013"), current));
			}
		}
