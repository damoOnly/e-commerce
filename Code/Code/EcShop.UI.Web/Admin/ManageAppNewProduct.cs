...
{
    [PrivilegeCheck(Privilege.ManageAppNewProduct)]
	public class ManageAppNewProduct : AdminPage
	{
		...
		{
            this.grdRecommend.DataSource = VShopHelper.GetAllRecommend(ClientType.App);
