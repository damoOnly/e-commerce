...
using System.Xml;
namespace EcShop.UI.Web.Installer
{
	public class Install : System.Web.UI.Page
	{
		...
		private void LoadParameters()
		{
			...
			if (flag)
			{
                ...
                this.siteName = ((string.IsNullOrEmpty(base.Request["SiteName"]) || base.Request["SiteName"].Trim().Length == 0) ? "Ecdev" : base.Request["SiteName"]);
            ...
            this.siteName = ((this.txtSiteName.Text.Trim().Length == 0) ? "Ecdev" : this.txtSiteName.Text);
