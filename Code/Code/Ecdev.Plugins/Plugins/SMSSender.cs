...
namespace Ecdev.Plugins
{
	public abstract class SMSSender : ConfigablePlugin, IPlugin
	{
        ...
        public abstract bool Send(string cellPhone, string message, int type, out string returnMsg);

        public abstract bool Send(string cellPhone, string message, int type, out string returnMsg, string speed = "0");
	}
}
