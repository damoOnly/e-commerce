...
namespace EcShop.UI.SaleSystem.CodeBehind
{
	...
	public class VReferralRegisterAgreement : VMemberTemplatedWebControl
	{
		...
		protected override void AttachChildControls()
		{
			...
			{
				this.Page.Response.Redirect(Globals.ApplicationPath + "/VShop/ReferralRegisterresults.aspx");
			}
