...
namespace EcShop.UI.SaleSystem.CodeBehind
{
    ...
    public class ActVProductDetails : VshopTemplatedWebControl
    {
        ...
        private System.Web.UI.HtmlControls.HtmlInputHidden hidd_ActiveTime;
        private System.Web.UI.HtmlControls.HtmlInputHidden hidd_Categories;
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            {
                this.SkinName = "skin-Act-vproductdetails.html";
            }
            base.OnInit(e);
        }
        protected override void AttachChildControls()
        {
            ...
            this.hidd_ActiveTime =        (System.Web.UI.HtmlControls.HtmlInputHidden)this.FindControl("hidd_ActiveTime");
            this.hidd_Categories = (System.Web.UI.HtmlControls.HtmlInputHidden)this.FindControl("hidd_Categories");
            this.hidd_Categories.Value = this.CateGoryId.ToString();
            ...
            ProductBrowseInfo productBrowseInfo = ProductBrowser.GetProductBrowseInfoByActive(this.productId,this.CateGoryId, null, null);
            ...
            //this.hidd_ActiveTime.Value = productBrowseInfo.Product.ActiveTime;//活动到期时间
            ...
            this.litSupplier.Text = "<a class=\"shop-link fix\" href=\"/vshop/SupplierDefault.aspx?SupplierId=" + productBrowseInfo.Product.SupplierId + "\"><span>进入店铺</span><img src=\"" + productBrowseInfo.SupplierLogo + "\"/>" + productBrowseInfo.SupplierName + "</a>";
