...
namespace EcShop.UI.SaleSystem.CodeBehind
{
	...
	public class VSubReferrals : VMemberTemplatedWebControl
	{
		private VshopTemplatedRepeater rptSubReferrals;
		...
		protected override void AttachChildControls()
		{
			...
			this.rptSubReferrals = (VshopTemplatedRepeater)this.FindControl("rptSubReferrals");
