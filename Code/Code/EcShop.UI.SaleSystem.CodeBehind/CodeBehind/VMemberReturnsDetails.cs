...
{
    public class VMemberReturnsDetails : VMemberTemplatedWebControl
    {
        ...
        private System.Web.UI.WebControls.Literal litCustomsClearanceFee;
        private System.Web.UI.WebControls.Literal litExpressFee;
        ...
        private VshopTemplatedRepeater RefundDetails;
        ...
        private void BindOrderItems(OrderInfo order)
        {
            ...
            this.litFeeAffiliation.Text = returnsInfo.FeeAffiliation;
            this.litExpressFee.Text = returnsInfo.ExpressFee.ToString("F2");
            this.litCustomsClearanceFee.Text = returnsInfo.CustomsClearanceFee.ToString("F2");
        }
