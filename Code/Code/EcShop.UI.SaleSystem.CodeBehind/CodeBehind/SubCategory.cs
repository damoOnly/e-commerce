...
namespace EcShop.UI.SaleSystem.CodeBehind
{
    ...
    public class SubCategory : HtmlTemplatedWebControl
    {
        ...
        // private System.Web.UI.WebControls.Literal litSearch;
        private System.Web.UI.WebControls.Literal litHotGood;
        ...
        private Common_AttributesList common_attributeslist;
        //txt_Search_Keywords
        public SubCategory()
        {
        ...
        protected void ReloadSearchResult(string sortOrder, string sortOrderBy)
        {
            ...
            nameValueCollection.Add("subKeywords", Globals.UrlEncode(DataHelper.CleanSearchString(this.cutdownSearch.Item.SubKeywords)));
        ...
        protected ProductBrowseQuery GetProductBrowseQuery()
        {
            ...
            if (!string.IsNullOrEmpty(this.Page.Request.QueryString["importsourceid"]))//新增原产地
            {
                int importsourceId = 0;
                if (int.TryParse(this.Page.Request.QueryString["importsourceid"], out importsourceId))
                {
                    productBrowseQuery.ImportsourceId = new int?(importsourceId);
                }
            }
            productBrowseQuery.PageIndex = this.pager == null ? 1 : this.pager.PageIndex;
            productBrowseQuery.PageSize = this.pager == null ? 5 : this.pager.PageSize;
