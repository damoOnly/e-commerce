...
{
	public class VCountDownProductDetail : VshopTemplatedWebControl
	{
        ...
        private System.Web.UI.HtmlControls.HtmlInputHidden hid_ActiveTime;
		...
		private void FindControls()
		{
            ...
            this.hid_ActiveTime = (System.Web.UI.HtmlControls.HtmlInputHidden)this.FindControl("hid_ActiveTime");
		}
		private void SetControlsValue(int countDownId)
		{
            ...
            if (countDownInfoByCountDownId.MaxCount > 0)
            {
                litMaxCount.Text = "<span id='maxCount'>限购：<span id='maxNum'>" + countDownInfoByCountDownId.MaxCount + "</span>件</span>";
            }
            else {
                litMaxCount.Text = "<span id='maxCount'></span>";
            }
            ...
            this.hid_ActiveTime.SetWhenIsNotNull(countDownInfoByCountDownId.ActiveTime.ToString());
            this.leftCount.SetWhenIsNotNull(productBrowseInfo.Product.Stock.ToString());
		}
	}
}
