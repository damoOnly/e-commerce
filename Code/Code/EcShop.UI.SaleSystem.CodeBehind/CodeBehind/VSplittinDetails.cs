...
namespace EcShop.UI.SaleSystem.CodeBehind
{
	...
	public class VSplittinDetails : VMemberTemplatedWebControl
	{
		private FormatedMoneyLabel litSplittinDraws;
		private FormatedMoneyLabel litAllSplittin;
		private VshopTemplatedRepeater rptSplittin;
		...
		protected override void AttachChildControls()
		{
			...
			this.rptSplittin = (VshopTemplatedRepeater)this.FindControl("rptSplittin");
