...
namespace EcShop.UI.SaleSystem.CodeBehind
{
	...
	public class VSubMembers : VMemberTemplatedWebControl
	{
		private VshopTemplatedRepeater rptSubMembers;
		...
		protected override void AttachChildControls()
		{
			...
			this.rptSubMembers = (VshopTemplatedRepeater)this.FindControl("rptSubMembers");
