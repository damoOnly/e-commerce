...
namespace EcShop.UI.SaleSystem.CodeBehind
{
	...
	public class AliOHMemberOrders : AliOHMemberTemplatedWebControl
	{
		private AliOHTemplatedRepeater rptOrders;
		...
		protected override void AttachChildControls()
		{
			...
			this.rptOrders = (AliOHTemplatedRepeater)this.FindControl("rptOrders");
