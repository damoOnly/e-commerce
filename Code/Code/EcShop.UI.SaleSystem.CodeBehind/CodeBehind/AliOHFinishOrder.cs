...
namespace EcShop.UI.SaleSystem.CodeBehind
{
	...
	public class AliOHFinishOrder : AliOHMemberTemplatedWebControl
	{
		...
		private void GotoPay()
		{
			...
			if (orderInfo.Gateway == "ecdev.plugins.payment.ws_wappay.wswappayrequest")
			{
				...
				string attach = "";
				string showUrl = string.Format("http://{0}/AliOH/", System.Web.HttpContext.Current.Request.Url.Host);
			...
			if (orderInfo.Gateway == "Ecdev.Plugins.Payment.ShengPayMobile.ShengPayMobileRequest")
			{
				...
				string attach2 = "";
				string text = string.Format("http://{0}/AliOH/", System.Web.HttpContext.Current.Request.Url.Host);
