...
namespace EcShop.UI.SaleSystem.CodeBehind
{
	...
	public class VSmashEgg : VActivityidTemplatedWebControl
	{
		...
		protected override void AttachChildControls()
		{
			...
			{
				System.Web.HttpContext.Current.Response.Redirect("/Vshop/login.aspx?ReturnUrl=/Vshop/Tocket.aspx?activityid=" + this.activityid);
				return;
			}
