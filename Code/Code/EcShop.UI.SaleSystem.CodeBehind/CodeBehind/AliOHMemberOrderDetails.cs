...
namespace EcShop.UI.SaleSystem.CodeBehind
{
	...
	public class AliOHMemberOrderDetails : AliOHMemberTemplatedWebControl
	{
		...
		private AliOHTemplatedRepeater rptOrderProducts;
		...
		protected override void AttachChildControls()
		{
			...
			this.rptOrderProducts = (AliOHTemplatedRepeater)this.FindControl("rptOrderProducts");
