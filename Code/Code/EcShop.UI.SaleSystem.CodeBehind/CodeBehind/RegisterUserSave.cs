...
namespace EcShop.UI.SaleSystem.CodeBehind
{
	public class RegisterUserSave : HtmlTemplatedWebControl
	{
		...
		private System.Web.UI.WebControls.TextBox txtWW;
		...
		protected override void AttachChildControls()
		{
			...
			this.txtWW = (System.Web.UI.WebControls.TextBox)this.FindControl("txtWW");
		...
		private void btnSaveUser_Click(object sender, System.EventArgs e)
		{
			...
			Member member = Users.GetUser(this.userId, false) as Member;
			...
			member.Wangwang = this.txtWW.Text;
