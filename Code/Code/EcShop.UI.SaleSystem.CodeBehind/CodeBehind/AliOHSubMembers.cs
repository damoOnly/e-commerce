...
namespace EcShop.UI.SaleSystem.CodeBehind
{
	...
	public class AliOHSubMembers : AliOHMemberTemplatedWebControl
	{
		private AliOHTemplatedRepeater rptSubMembers;
		...
		protected override void AttachChildControls()
		{
			...
			this.rptSubMembers = (AliOHTemplatedRepeater)this.FindControl("rptSubMembers");
