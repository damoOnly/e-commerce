...
namespace EcShop.Jobs
{
	public class SiteMapJob : IJob
	{
		...
		public void CreateCateXml()
		{
			...
			System.Data.Common.DbCommand sqlStringCommand = this.database.GetSqlStringCommand("select CategoryId,RewriteName from Ecshop_Categories");
			using (System.Data.IDataReader dataReader = this.database.ExecuteReader(sqlStringCommand))
			{
				while (dataReader.Read())
				{
					...
					xmlElement9.InnerText = this.prourl + Globals.GetSiteUrls().SubCategory(Convert.ToInt32(dataReader["CategoryId"]), dataReader["RewriteName"]);
					XmlElement xmlElement10 = xmlDocument.CreateElement("wml_url", xmlElement8.NamespaceURI);
					xmlElement10.InnerText = this.prourl + Globals.GetSiteUrls().SubCategory(Convert.ToInt32(dataReader["CategoryId"]), dataReader["RewriteName"]);
					XmlElement xmlElement11 = xmlDocument.CreateElement("xhtml_url", xmlElement8.NamespaceURI);
					xmlElement11.InnerText = this.prourl + Globals.GetSiteUrls().SubCategory(Convert.ToInt32(dataReader["CategoryId"]), dataReader["RewriteName"]);
		...
		public void CreateArticleXml()
		{
			...
			XmlElement xmlElement = xmlDocument.CreateElement("", "urlset", "http://www.sitemaps.org/schemas/sitemap/0.9");
			xmlDocument.AppendChild(xmlElement);
			System.Data.Common.DbCommand sqlStringCommand = this.database.GetSqlStringCommand("select ArticleId from dbo.Ecshop_Articles where IsRelease='1'");
			using (System.Data.IDataReader dataReader = this.database.ExecuteReader(sqlStringCommand))
			{
				while (dataReader.Read())
				{
					...
					XmlElement xmlElement8 = xmlDocument.CreateElement("display", xmlElement7.NamespaceURI);
					XmlElement xmlElement9 = xmlDocument.CreateElement("html5_url", xmlElement8.NamespaceURI);
					xmlElement9.InnerText = this.prourl + Globals.GetSiteUrls().UrlData.FormatUrl("ArticleDetails", new object[]
					{
						Convert.ToInt32(dataReader["ArticleId"])
					});
					XmlElement xmlElement10 = xmlDocument.CreateElement("wml_url", xmlElement8.NamespaceURI);
					xmlElement10.InnerText = this.prourl + Globals.GetSiteUrls().UrlData.FormatUrl("ArticleDetails", new object[]
					{
						Convert.ToInt32(dataReader["ArticleId"])
					});
					XmlElement xmlElement11 = xmlDocument.CreateElement("xhtml_url", xmlElement8.NamespaceURI);
					xmlElement11.InnerText = this.prourl + Globals.GetSiteUrls().UrlData.FormatUrl("ArticleDetails", new object[]
					{
						Convert.ToInt32(dataReader["ArticleId"])
					});
					xmlElement7.AppendChild(xmlElement8);
		...
		public void CreateProductXml()
		{
			...
			{
				sqlStringCommand = this.database.GetSqlStringCommand("select top " + num + " productid from dbo.Ecshop_Products where salestatus=1  order by productid desc");
			}
			else
			{
				sqlStringCommand = this.database.GetSqlStringCommand("select top  1000 productid from dbo.Ecshop_Products where salestatus=1 order by productid desc");
			}
			using (System.Data.IDataReader dataReader = this.database.ExecuteReader(sqlStringCommand))
			{
				while (dataReader.Read())
				{
					...
					XmlElement xmlElement8 = xmlDocument.CreateElement("display", xmlElement7.NamespaceURI);
					XmlElement xmlElement9 = xmlDocument.CreateElement("html5_url", xmlElement8.NamespaceURI);
					xmlElement9.InnerText = this.prourl + Globals.GetSiteUrls().UrlData.FormatUrl("productDetails", new object[]
					{
						Convert.ToInt32(dataReader["productid"])
					});
					XmlElement xmlElement10 = xmlDocument.CreateElement("wml_url", xmlElement8.NamespaceURI);
					xmlElement10.InnerText = this.prourl + Globals.GetSiteUrls().UrlData.FormatUrl("productDetails", new object[]
					{
						Convert.ToInt32(dataReader["productid"])
					});
					XmlElement xmlElement11 = xmlDocument.CreateElement("xhtml_url", xmlElement8.NamespaceURI);
					xmlElement11.InnerText = this.prourl + Globals.GetSiteUrls().UrlData.FormatUrl("productDetails", new object[]
					{
						Convert.ToInt32(dataReader["productid"])
					});
					xmlElement7.AppendChild(xmlElement8);
