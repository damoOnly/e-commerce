...
namespace EcShop.Jobs
{
    public class FtpHelper
    {
        ...
        /// <returns></returns>
        public List<string> GetDirctory(string username, string password, string path)
        {
        ...
        /// <returns></returns>
        public List<string> GetFile(string username, string password, string path, string RequedstPath)
        {
            List<string> strs = new List<string>();
            try
            {
